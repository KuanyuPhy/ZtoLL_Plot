...
void HT_factory()
{
    ...
    //----------------------------------------------------------------------
    // Create Histrogram: Met, PT, eta, nJet, Jethadronflavor,ndisJet, alpha3D, alpha3Dmin
    //, log10(Chi3D), log10(Chi2D), NTracks,
    //
    //----------------------------------------------------------------------
    // 1. Met
    ...
    // 2. Jet PT
    TH1F *h_ht0_jetpt = new TH1F("h_ht0_jetpt", "jet pt", 100, 0, 1000);
    h_ht0_jetpt->Sumw2();
    TH1F *h_ht70_jetpt = new TH1F("h_ht70_jetpt", "jet pt", 100, 0, 1000);
    h_ht70_jetpt->Sumw2();
    TH1F *h_ht100_jetpt = new TH1F("h_ht100_jetpt", "jet pt", 100, 0, 1000);
    h_ht100_jetpt->Sumw2();
    TH1F *h_ht200_jetpt = new TH1F("h_ht200_jetpt", "jet pt", 100, 0, 1000);
    h_ht200_jetpt->Sumw2();
    TH1F *h_ht400_jetpt = new TH1F("h_ht400_jetpt", "jet pt", 100, 0, 1000);
    h_ht400_jetpt->Sumw2();
    TH1F *h_ht600_jetpt = new TH1F("h_ht600_jetpt", "jet pt", 100, 0, 1000);
    h_ht600_jetpt->Sumw2();
    TH1F *h_ht800_jetpt = new TH1F("h_ht800_jetpt", "jet pt", 100, 0, 1000);
    h_ht800_jetpt->Sumw2();
    TH1F *h_ht1200_jetpt = new TH1F("h_ht1200_jetpt", "jet pt", 100, 0, 1000);
    h_ht1200_jetpt->Sumw2();
    TH1F *h_ht2500_jetpt = new TH1F("h_ht2500_jetpt", "jet pt", 100, 0, 1000);
    h_ht2500_jetpt->Sumw2();

    // 3. Jet eta
    TH1F *h_ht0_jeteta = new TH1F("h_ht0_jeteta", "jet eta", 100, -5, 5);
    h_ht0_jeteta->Sumw2();
    TH1F *h_ht70_jeteta = new TH1F("h_ht70_jeteta", "jet eta", 100, -5, 5);
    h_ht70_jeteta->Sumw2();
    TH1F *h_ht100_jeteta = new TH1F("h_ht100_jeteta", "jet eta", 100, -5, 5);
    h_ht100_jeteta->Sumw2();
    TH1F *h_ht200_jeteta = new TH1F("h_ht200_jeteta", "jet eta", 100, -5, 5);
    h_ht200_jeteta->Sumw2();
    TH1F *h_ht400_jeteta = new TH1F("h_ht400_jeteta", "jet eta", 100, -5, 5);
    h_ht400_jeteta->Sumw2();
    TH1F *h_ht600_jeteta = new TH1F("h_ht600_jeteta", "jet eta", 100, -5, 5);
    h_ht600_jeteta->Sumw2();
    TH1F *h_ht800_jeteta = new TH1F("h_ht800_jeteta", "jet eta", 100, -5, 5);
    h_ht800_jeteta->Sumw2();
    TH1F *h_ht1200_jeteta = new TH1F("h_ht1200_jeteta", "jet eta", 100, -5, 5);
    h_ht1200_jeteta->Sumw2();
    TH1F *h_ht2500_jeteta = new TH1F("h_ht2500_jeteta", "jet eta", 100, -5, 5);
    h_ht2500_jeteta->Sumw2();
    ...
    // 10. alpha3D
    TH1F *h_ht0_alpha3D = new TH1F("h_ht0_alpha3D", "", 24, 0, 1.2);
    h_ht0_alpha3D->SetYTitle("N Jets");
    h_ht0_alpha3D->Sumw2();
    TH1F *h_ht70_alpha3D = new TH1F("h_ht70_alpha3D", "", 24, 0, 1.2);
    h_ht70_alpha3D->SetYTitle("N Jets");
    h_ht70_alpha3D->Sumw2();
    TH1F *h_ht100_alpha3D = new TH1F("h_ht100_alpha3D", "", 24, 0, 1.2);
    h_ht100_alpha3D->SetYTitle("N Jets");
    h_ht100_alpha3D->Sumw2();
    TH1F *h_ht200_alpha3D = new TH1F("h_ht200_alpha3D", "", 24, 0, 1.2);
    h_ht200_alpha3D->SetYTitle("N Jets");
    h_ht200_alpha3D->Sumw2();
    TH1F *h_ht400_alpha3D = new TH1F("h_ht400_alpha3D", "", 24, 0, 1.2);
    h_ht400_alpha3D->SetYTitle("N Jets");
    h_ht400_alpha3D->Sumw2();
    TH1F *h_ht600_alpha3D = new TH1F("h_ht600_alpha3D", "", 24, 0, 1.2);
    h_ht600_alpha3D->SetYTitle("N Jets");
    h_ht600_alpha3D->Sumw2();
    TH1F *h_ht800_alpha3D = new TH1F("h_ht800_alpha3D", "", 24, 0, 1.2);
    h_ht800_alpha3D->SetYTitle("N Jets");
    h_ht800_alpha3D->Sumw2();
    TH1F *h_ht1200_alpha3D = new TH1F("h_ht1200_alpha3D", "", 24, 0, 1.2);
    h_ht1200_alpha3D->SetYTitle("N Jets");
    h_ht1200_alpha3D->Sumw2();
    TH1F *h_ht2500_alpha3D = new TH1F("h_ht2500_alpha3D", "", 24, 0, 1.2);
    h_ht2500_alpha3D->SetYTitle("N Jets");
    h_ht2500_alpha3D->Sumw2();
    ...
    // 12. log10(Chi2D)
    // 13. log10(Chi3D)
    TH1F *h_ht0_log3Dsig = new TH1F("h_ht0_log3Dsig", "", 100, -10, 10);
    h_ht0_log3Dsig->SetYTitle("N Jets");
    h_ht0_log3Dsig->Sumw2();
    TH1F *h_ht70_log3Dsig = new TH1F("h_ht70_log3Dsig", "", 100, -10, 10);
    h_ht70_log3Dsig->Sumw2();
    TH1F *h_ht100_log3Dsig = new TH1F("h_ht100_log3Dsig", "", 100, -10, 10);
    h_ht100_log3Dsig->Sumw2();
    TH1F *h_ht200_log3Dsig = new TH1F("h_ht200_log3Dsig", "", 100, -10, 10);
    h_ht200_log3Dsig->Sumw2();
    TH1F *h_ht400_log3Dsig = new TH1F("h_ht400_log3Dsig", "", 100, -10, 10);
    h_ht400_log3Dsig->Sumw2();
    TH1F *h_ht600_log3Dsig = new TH1F("h_ht600_log3Dsig", "", 100, -10, 10);
    h_ht600_log3Dsig->Sumw2();
    TH1F *h_ht800_log3Dsig = new TH1F("h_ht800_log3Dsig", "", 100, -10, 10);
    h_ht800_log3Dsig->Sumw2();
    TH1F *h_ht1200_log3Dsig = new TH1F("h_ht1200_log3Dsig", "", 100, -10, 10);
    h_ht1200_log3Dsig->Sumw2();
    TH1F *h_ht2500_log3Dsig = new TH1F("h_ht2500_log3Dsig", "", 100, -10, 10);
    h_ht2500_log3Dsig->Sumw2();

    // 14. Median(Chi2D)
    // 15. NTracks
    TH1F *h_ht0_disJet_nTracks = new TH1F("h_ht0_disJet_nTracks", "", 10, 0, 10);
    h_ht0_disJet_nTracks->SetYTitle("N event");
    h_ht0_disJet_nTracks->Sumw2();
    TH1F *h_ht70_disJet_nTracks = new TH1F("h_ht70_disJet_nTracks", "", 10, 0, 10);
    h_ht70_disJet_nTracks->Sumw2();
    TH1F *h_ht100_disJet_nTracks = new TH1F("h_ht100_disJet_nTracks", "", 10, 0, 10);
    h_ht100_disJet_nTracks->Sumw2();
    TH1F *h_ht200_disJet_nTracks = new TH1F("h_ht200_disJet_nTracks", "", 10, 0, 10);
    h_ht200_disJet_nTracks->Sumw2();
    TH1F *h_ht400_disJet_nTracks = new TH1F("h_ht400_disJet_nTracks", "", 10, 0, 10);
    h_ht400_disJet_nTracks->Sumw2();
    TH1F *h_ht600_disJet_nTracks = new TH1F("h_ht600_disJet_nTracks", "", 10, 0, 10);
    h_ht600_disJet_nTracks->Sumw2();
    TH1F *h_ht800_disJet_nTracks = new TH1F("h_ht800_disJet_nTracks", "", 10, 0, 10);
    h_ht800_disJet_nTracks->Sumw2();
    TH1F *h_ht1200_disJet_nTracks = new TH1F("h_ht1200_disJet_nTracks", "", 10, 0, 10);
    h_ht1200_disJet_nTracks->Sumw2();
    TH1F *h_ht2500_disJet_nTracks = new TH1F("h_ht2500_disJet_nTracks", "", 10, 0, 10);
    h_ht2500_disJet_nTracks->Sumw2();
