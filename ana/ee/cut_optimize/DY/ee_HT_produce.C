...
void ee_HT_produce(TString inputfile = "./../../../../../../root_file/Ztoee/2016BKGMC/DY/ee_DYincli.root", TString outputfile1 = "./ee_DY_emjet.root")
{
    ...
    for (int evt = 0; evt < T_tree->GetEntries(); evt++)
    {
        ...
        if (HT < 70)
        {
            float HT0_eventWeight = I_ht0_weight * HT0Weight;
            ...
            {
                h_DY_IP2D->Fill(log10(abs((*v_ht0_2DIP)[i])), HT0_eventWeight);
            }
            //--------------------------------
        ...
        {
            float HT70_eventWeight = I_ht0_weight * HT70Weight;
            ...
            for (size_t i = 0; i < v_ht0_2DIP->size(); i++)
            {
                h_DY_IP2D->Fill(log10(abs((*v_ht0_2DIP)[i])), HT70_eventWeight);
            }
            for (size_t i = 0; i < v_ht0_nTrack->size(); i++)
            {
        ...
        {
            float HT100_eventWeight = I_ht0_weight * HT100Weight;
            ...
            for (size_t i = 0; i < v_ht0_2DIP->size(); i++)
            {
                h_DY_IP2D->Fill(log10(abs((*v_ht0_2DIP)[i])), HT100_eventWeight);
            }
            for (size_t i = 0; i < v_ht0_nTrack->size(); i++)
            {
        ...
        else if (HT >= 200 && HT < 400)
        {
            ...
            float HT200_eventWeight = I_ht0_weight * HT200Weight;
            ...
            for (size_t i = 0; i < v_ht0_2DIP->size(); i++)
            {
                h_DY_IP2D->Fill(log10(abs((*v_ht0_2DIP)[i])), HT200_eventWeight);
            }
            for (size_t i = 0; i < v_ht0_nTrack->size(); i++)
            {
        ...
        {
            float HT400_eventWeight = I_ht0_weight * HT400Weight;
            ...
            for (size_t i = 0; i < v_ht0_2DIP->size(); i++)
            {
                h_DY_IP2D->Fill(log10(abs((*v_ht0_2DIP)[i])), HT400_eventWeight);
            }
            for (size_t i = 0; i < v_ht0_nTrack->size(); i++)
            {
        ...
        {
            float HT600_eventWeight = I_ht0_weight * HT600Weight;
            ...
            for (size_t i = 0; i < v_ht0_2DIP->size(); i++)
            {
                h_DY_IP2D->Fill(log10(abs((*v_ht0_2DIP)[i])), HT600_eventWeight);
            }
            for (size_t i = 0; i < v_ht0_nTrack->size(); i++)
            {
        ...
        {
            float HT800_eventWeight = I_ht0_weight * HT800Weight;
            ...
            for (size_t i = 0; i < v_ht0_2DIP->size(); i++)
            {
                h_DY_IP2D->Fill(log10(abs((*v_ht0_2DIP)[i])), HT800_eventWeight);
            }
            for (size_t i = 0; i < v_ht0_nTrack->size(); i++)
            {
        ...
        {
            float HT1200_eventWeight = I_ht0_weight * HT1200Weight;
            ...
            for (size_t i = 0; i < v_ht0_2DIP->size(); i++)
            {
                h_DY_IP2D->Fill(log10(abs((*v_ht0_2DIP)[i])), HT1200_eventWeight);
            }
            for (size_t i = 0; i < v_ht0_nTrack->size(); i++)
            {
        ...
        {
            float HT2500_eventWeight = I_ht0_weight * HT2500Weight;
            ...
            for (size_t i = 0; i < v_ht0_2DIP->size(); i++)
            {
                h_DY_IP2D->Fill(log10(abs((*v_ht0_2DIP)[i])), HT2500_eventWeight);
            }
            for (size_t i = 0; i < v_ht0_nTrack->size(); i++)
            {
    ...
    for (int evt = 0; evt < T_tree2->GetEntries(); evt++)
    {
        ...
        float HT100_eventWeight = I_ht100_weight * HT100Weight;
        ...
        {
            h_DY_IP2D->Fill(log10(abs((*v_ht100_2DIP)[i])), HT100_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_tree3->GetEntries(); evt++)
    {
        ...
        float HT200_eventWeight = I_ht200_weight * HT200Weight;
        ...
        {
            h_DY_IP2D->Fill(log10(abs((*v_ht200_2DIP)[i])), HT200_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_tree4->GetEntries(); evt++)
    {
        ...
        float HT400_eventWeight = I_ht400_weight * HT400Weight;
        ...
        {
            h_DY_IP2D->Fill(log10(abs((*v_ht400_2DIP)[i])), HT400_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_tree5->GetEntries(); evt++)
    {
        ...
        float HT600_eventWeight = I_ht600_weight * HT600Weight;
        ...
        {
            h_DY_IP2D->Fill(log10(abs((*v_ht600_2DIP)[i])), HT600_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_tree6->GetEntries(); evt++)
    {
        ...
        float HT800_eventWeight = I_ht800_weight * HT800Weight;
        ...
        {
            h_DY_IP2D->Fill(log10(abs((*v_ht800_2DIP)[i])), HT800_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_tree7->GetEntries(); evt++)
    {
        ...
        float HT1200_eventWeight = I_ht1200_weight * HT1200Weight;
        ...
        {
            h_DY_IP2D->Fill(log10(abs((*v_ht1200_2DIP)[i])), HT1200_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_tree8->GetEntries(); evt++)
    {
        ...
        float HT2500_eventWeight = I_ht2500_weight * HT2500Weight;
        ...
        {
            h_DY_IP2D->Fill(log10(abs((*v_ht2500_2DIP)[i])), HT2500_eventWeight);
        }
