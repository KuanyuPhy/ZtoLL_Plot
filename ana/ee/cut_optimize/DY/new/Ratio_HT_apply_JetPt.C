...
void Ratio_HT_apply_JetPt()
{
    ...
    TH1D *h_DY_JetPt_CR = new TH1D("h_DY_JetPt_CR", "", 50, 0, 500);
    h_DY_JetPt_CR->GetXaxis()->SetTitle("");
    h_DY_JetPt_CR->GetYaxis()->SetTitle("");
    h_DY_JetPt_CR->Sumw2();
    ...
    TH1D *h_DY_JetPt_heavy_CR = new TH1D("h_DY_JetPt_heavy_CR", "", 50, 0, 500);
    h_DY_JetPt_heavy_CR->GetXaxis()->SetTitle("");
    h_DY_JetPt_heavy_CR->GetYaxis()->SetTitle("");
    h_DY_JetPt_heavy_CR->Sumw2();
    ...
    TH1D *h_DY_JetPt_bjet_bybin_CR = new TH1D("h_DY_JetPt_bjet_bybin_CR", "", 50, 0, 500);
    h_DY_JetPt_bjet_bybin_CR->GetXaxis()->SetTitle("");
    h_DY_JetPt_bjet_bybin_CR->GetYaxis()->SetTitle("");
    h_DY_JetPt_bjet_bybin_CR->Sumw2();
    ...
    TH1D *h_DY_JetPt_cjet_bybin_CR = new TH1D("h_DY_JetPt_cjet_bybin_CR", "", 50, 0, 500);
    h_DY_JetPt_cjet_bybin_CR->GetXaxis()->SetTitle("");
    h_DY_JetPt_cjet_bybin_CR->GetYaxis()->SetTitle("");
    h_DY_JetPt_cjet_bybin_CR->Sumw2();
    ...
    TH1D *h_DY_JetPt_light_bybin_CR = new TH1D("h_DY_JetPt_light_bybin_CR", "", 50, 0, 500);
    h_DY_JetPt_light_bybin_CR->GetXaxis()->SetTitle("");
    h_DY_JetPt_light_bybin_CR->GetYaxis()->SetTitle("");
    h_DY_JetPt_light_bybin_CR->Sumw2();
    ...
    for (int evt = 0; evt < Treeh0->GetEntries(); evt++)
    {
        ...
        if (HT < 70)
        {
            ...
            {
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT0Weight, h_DY_JetPt_bjet);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT0Weight, h_DY_JetPt_cjet);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT0Weight, h_DY_JetPt_light);
                //----------------------------
                ...
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], bin_bjetWeight, h_DY_JetPt_bjet_bybin_CR);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], bin_cjetWeight, h_DY_JetPt_cjet_bybin_CR);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], bin_lightjetWeight, h_DY_JetPt_light_bybin_CR);
                //----------------------------
                ...
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], rootfit_bjetWeight, h_DY_JetPt_bjet_CR);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], rootfit_cjetWeight, h_DY_JetPt_cjet_CR);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], rootfit_lightjetWeight, h_DY_JetPt_light_CR);
                //----------------------------
                // Signal Region
                //----------------------------
                if ((*v_ht0_alpha)[i] < 0.15)
                {
                    for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT0Weight, h_DY_JetPt_bjet_cut);
                    for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT0Weight, h_DY_JetPt_cjet_cut);
                    for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT0Weight, h_DY_JetPt_light_cut);
                }
            }
        }
        else if (HT >= 70 && HT < 100)
        {
            for (size_t i = 0; i < v_ht0_JetPt->size(); i++)
            {
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT70Weight, h_DY_JetPt_bjet);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT70Weight, h_DY_JetPt_cjet);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT70Weight, h_DY_JetPt_light);
                //----------------------------
                // apply bin by bin fake rate
                //----------------------------
                ...
                if ((*v_ht0_alpha)[i] < 0.15)
                {
                    for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT70Weight, h_DY_JetPt_bjet_cut);
                    for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT70Weight, h_DY_JetPt_cjet_cut);
                    for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT70Weight, h_DY_JetPt_light_cut);
                }
            }
        }
        else if (HT >= 100 && HT < 200)
        {
            for (size_t i = 0; i < v_ht0_JetPt->size(); i++)
            {
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT100Weight, h_DY_JetPt_bjet);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT100Weight, h_DY_JetPt_cjet);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT100Weight, h_DY_JetPt_light);
                //----------------------------
                // apply bin by bin fake rate
                //----------------------------
                ...
                if ((*v_ht0_alpha)[i] < 0.15)
                {
                    for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT100Weight, h_DY_JetPt_bjet_cut);
                    for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT100Weight, h_DY_JetPt_cjet_cut);
                    for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT100Weight, h_DY_JetPt_light_cut);
                }
            }
        }
        else if (HT >= 200 && HT < 400)
        {
            for (size_t i = 0; i < v_ht0_JetPt->size(); i++)
            {
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT200Weight, h_DY_JetPt_bjet);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT200Weight, h_DY_JetPt_cjet);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT200Weight, h_DY_JetPt_light);
                //----------------------------
                // apply bin by bin fake rate
                //----------------------------
                ...
                if ((*v_ht0_alpha)[i] < 0.15)
                {
                    for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT200Weight, h_DY_JetPt_bjet_cut);
                    for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT200Weight, h_DY_JetPt_cjet_cut);
                    for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT200Weight, h_DY_JetPt_light_cut);
                }
            }
        }
        else if (HT >= 400 && HT < 600)
        {
            for (size_t i = 0; i < v_ht0_JetPt->size(); i++)
            {
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT400Weight, h_DY_JetPt_bjet);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT400Weight, h_DY_JetPt_cjet);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT400Weight, h_DY_JetPt_light);
                //----------------------------
                // apply bin by bin fake rate
                //----------------------------
                ...
                if ((*v_ht0_alpha)[i] < 0.15)
                {
                    for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT400Weight, h_DY_JetPt_bjet_cut);
                    for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT400Weight, h_DY_JetPt_cjet_cut);
                    for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT400Weight, h_DY_JetPt_light_cut);
                }
            }
        }
        else if (HT >= 600 && HT < 800)
        {
            for (size_t i = 0; i < v_ht0_JetPt->size(); i++)
            {
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT600Weight, h_DY_JetPt_bjet);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT600Weight, h_DY_JetPt_cjet);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT600Weight, h_DY_JetPt_light);
                //----------------------------
                // apply bin by bin fake rate
                //----------------------------
                ...
                if ((*v_ht0_alpha)[i] < 0.15)
                {
                    for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT600Weight, h_DY_JetPt_bjet_cut);
                    for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT600Weight, h_DY_JetPt_cjet_cut);
                    for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT600Weight, h_DY_JetPt_light_cut);
                }
            }
        }
        else if (HT >= 800 && HT < 1200)
        {
            for (size_t i = 0; i < v_ht0_JetPt->size(); i++)
            {
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT800Weight, h_DY_JetPt_bjet);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT800Weight, h_DY_JetPt_cjet);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT800Weight, h_DY_JetPt_light);
                //----------------------------
                // apply bin by bin fake rate
                //----------------------------
                ...
                if ((*v_ht0_alpha)[i] < 0.15)
                {
                    for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT800Weight, h_DY_JetPt_bjet_cut);
                    for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT800Weight, h_DY_JetPt_cjet_cut);
                    for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT800Weight, h_DY_JetPt_light_cut);
                }
            }
        }
        else if (HT >= 1200 && HT < 2500)
        {
            for (size_t i = 0; i < v_ht0_JetPt->size(); i++)
            {
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT1200Weight, h_DY_JetPt_bjet);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT1200Weight, h_DY_JetPt_cjet);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT1200Weight, h_DY_JetPt_light);
                //----------------------------
                // apply bin by bin fake rate
                //----------------------------
                ...
                if ((*v_ht0_alpha)[i] < 0.15)
                {
                    for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT1200Weight, h_DY_JetPt_bjet_cut);
                    for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT1200Weight, h_DY_JetPt_cjet_cut);
                    for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT1200Weight, h_DY_JetPt_light_cut);
                }
            }
        }
        else if (HT >= 2500)
        {
            for (size_t i = 0; i < v_ht0_JetPt->size(); i++)
            {
                for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT2500Weight, h_DY_JetPt_bjet);
                for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT2500Weight, h_DY_JetPt_cjet);
                for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT2500Weight, h_DY_JetPt_light);
                //----------------------------
                // apply bin by bin fake rate
                //----------------------------
                ...
                if ((*v_ht0_alpha)[i] < 0.15)
                {
                    for_signalflavor_jet(5, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT2500Weight, h_DY_JetPt_bjet_cut);
                    for_signalflavor_jet(4, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT2500Weight, h_DY_JetPt_cjet_cut);
                    for_signalflavor_jet(0, (*v_ht0_Jethadronflavor)[i], (*v_ht0_JetPt)[i], HT2500Weight, h_DY_JetPt_light_cut);
                }
            }
        }
    } // End of DY_inclusive
    ...
    for (int evt = 0; evt < T_tree2->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ht100_JetPt->size(); i++)
        {
            for_signalflavor_jet(5, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], HT100Weight, h_DY_JetPt_bjet);
            for_signalflavor_jet(4, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], HT100Weight, h_DY_JetPt_cjet);
            for_signalflavor_jet(0, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], HT100Weight, h_DY_JetPt_light);
            //----------------------------
            // apply bin by bin fake rate
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], bin_bjetWeight, h_DY_JetPt_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], bin_cjetWeight, h_DY_JetPt_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], bin_lightjetWeight, h_DY_JetPt_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], rootfit_bjetWeight, h_DY_JetPt_bjet_CR);
            for_signalflavor_jet(4, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], rootfit_cjetWeight, h_DY_JetPt_cjet_CR);
            for_signalflavor_jet(0, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], rootfit_lightjetWeight, h_DY_JetPt_light_CR);
            //----------------------------
            // Signal Region
            //----------------------------
            if ((*v_ht100_alpha)[i] < 0.15)
            {
                for_signalflavor_jet(5, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], HT100Weight, h_DY_JetPt_bjet_cut);
                for_signalflavor_jet(4, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], HT100Weight, h_DY_JetPt_cjet_cut);
                for_signalflavor_jet(0, (*v_ht100_Jethadronflavor)[i], (*v_ht100_JetPt)[i], HT100Weight, h_DY_JetPt_light_cut);
            }
        }
    }
    TTree *T_tree3;
    ...
    for (int evt = 0; evt < T_tree3->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ht200_JetPt->size(); i++)
        {
            for_signalflavor_jet(5, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], HT200Weight, h_DY_JetPt_bjet);
            for_signalflavor_jet(4, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], HT200Weight, h_DY_JetPt_cjet);
            for_signalflavor_jet(0, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], HT200Weight, h_DY_JetPt_light);
            //----------------------------
            // apply bin by bin fake rate
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], bin_bjetWeight, h_DY_JetPt_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], bin_cjetWeight, h_DY_JetPt_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], bin_lightjetWeight, h_DY_JetPt_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], rootfit_bjetWeight, h_DY_JetPt_bjet_CR);
            for_signalflavor_jet(4, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], rootfit_cjetWeight, h_DY_JetPt_cjet_CR);
            for_signalflavor_jet(0, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], rootfit_lightjetWeight, h_DY_JetPt_light_CR);
            //----------------------------
            // Signal Region
            //----------------------------
            if ((*v_ht200_alpha)[i] < 0.15)
            {
                for_signalflavor_jet(5, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], HT200Weight, h_DY_JetPt_bjet_cut);
                for_signalflavor_jet(4, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], HT200Weight, h_DY_JetPt_cjet_cut);
                for_signalflavor_jet(0, (*v_ht200_Jethadronflavor)[i], (*v_ht200_JetPt)[i], HT200Weight, h_DY_JetPt_light_cut);
            }
        }
    }
    TTree *T_tree4;
    ...
    for (int evt = 0; evt < T_tree4->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ht400_JetPt->size(); i++)
        {
            for_signalflavor_jet(5, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], HT400Weight, h_DY_JetPt_bjet);
            for_signalflavor_jet(4, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], HT400Weight, h_DY_JetPt_cjet);
            for_signalflavor_jet(0, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], HT400Weight, h_DY_JetPt_light);
            //----------------------------
            // apply bin by bin fake rate
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], bin_bjetWeight, h_DY_JetPt_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], bin_cjetWeight, h_DY_JetPt_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], bin_lightjetWeight, h_DY_JetPt_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], rootfit_bjetWeight, h_DY_JetPt_bjet_CR);
            for_signalflavor_jet(4, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], rootfit_cjetWeight, h_DY_JetPt_cjet_CR);
            for_signalflavor_jet(0, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], rootfit_lightjetWeight, h_DY_JetPt_light_CR);
            //----------------------------
            // Signal Region
            //----------------------------
            if ((*v_ht400_alpha)[i] < 0.15)
            {
                for_signalflavor_jet(5, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], HT400Weight, h_DY_JetPt_bjet_cut);
                for_signalflavor_jet(4, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], HT400Weight, h_DY_JetPt_cjet_cut);
                for_signalflavor_jet(0, (*v_ht400_Jethadronflavor)[i], (*v_ht400_JetPt)[i], HT400Weight, h_DY_JetPt_light_cut);
            }
        }
    }
    TTree *T_tree5;
    ...
    for (int evt = 0; evt < T_tree5->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ht600_JetPt->size(); i++)
        {
            for_signalflavor_jet(5, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], HT600Weight, h_DY_JetPt_bjet);
            for_signalflavor_jet(4, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], HT600Weight, h_DY_JetPt_cjet);
            for_signalflavor_jet(0, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], HT600Weight, h_DY_JetPt_light);
            //----------------------------
            // apply bin by bin fake rate
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], bin_bjetWeight, h_DY_JetPt_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], bin_cjetWeight, h_DY_JetPt_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], bin_lightjetWeight, h_DY_JetPt_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], rootfit_bjetWeight, h_DY_JetPt_bjet_CR);
            for_signalflavor_jet(4, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], rootfit_cjetWeight, h_DY_JetPt_cjet_CR);
            for_signalflavor_jet(0, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], rootfit_lightjetWeight, h_DY_JetPt_light_CR);
            //----------------------------
            // Signal Region
            //----------------------------
            if ((*v_ht600_alpha)[i] < 0.15)
            {
                for_signalflavor_jet(5, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], HT600Weight, h_DY_JetPt_bjet_cut);
                for_signalflavor_jet(4, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], HT600Weight, h_DY_JetPt_cjet_cut);
                for_signalflavor_jet(0, (*v_ht600_Jethadronflavor)[i], (*v_ht600_JetPt)[i], HT600Weight, h_DY_JetPt_light_cut);
            }
        }
    }
    TTree *T_tree6;
    ...
    for (int evt = 0; evt < T_tree6->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ht800_JetPt->size(); i++)
        {
            for_signalflavor_jet(5, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], HT800Weight, h_DY_JetPt_bjet);
            for_signalflavor_jet(4, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], HT800Weight, h_DY_JetPt_cjet);
            for_signalflavor_jet(0, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], HT800Weight, h_DY_JetPt_light);
            //----------------------------
            // apply bin by bin fake rate
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], bin_bjetWeight, h_DY_JetPt_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], bin_cjetWeight, h_DY_JetPt_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], bin_lightjetWeight, h_DY_JetPt_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], rootfit_bjetWeight, h_DY_JetPt_bjet_CR);
            for_signalflavor_jet(4, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], rootfit_cjetWeight, h_DY_JetPt_cjet_CR);
            for_signalflavor_jet(0, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], rootfit_lightjetWeight, h_DY_JetPt_light_CR);
            //----------------------------
            // Signal Region
            //----------------------------
            if ((*v_ht800_alpha)[i] < 0.15)
            {
                for_signalflavor_jet(5, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], HT800Weight, h_DY_JetPt_bjet_cut);
                for_signalflavor_jet(4, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], HT800Weight, h_DY_JetPt_cjet_cut);
                for_signalflavor_jet(0, (*v_ht800_Jethadronflavor)[i], (*v_ht800_JetPt)[i], HT800Weight, h_DY_JetPt_light_cut);
            }
        }
    }
    TTree *T_tree7;
    ...
    for (int evt = 0; evt < T_tree7->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ht1200_JetPt->size(); i++)
        {
            for_signalflavor_jet(5, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], HT1200Weight, h_DY_JetPt_bjet);
            for_signalflavor_jet(4, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], HT1200Weight, h_DY_JetPt_cjet);
            for_signalflavor_jet(0, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], HT1200Weight, h_DY_JetPt_light);
            //----------------------------
            // apply bin by bin fake rate
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], bin_bjetWeight, h_DY_JetPt_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], bin_cjetWeight, h_DY_JetPt_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], bin_lightjetWeight, h_DY_JetPt_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], rootfit_bjetWeight, h_DY_JetPt_bjet_CR);
            for_signalflavor_jet(4, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], rootfit_cjetWeight, h_DY_JetPt_cjet_CR);
            for_signalflavor_jet(0, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], rootfit_lightjetWeight, h_DY_JetPt_light_CR);
            //----------------------------
            // Signal Region
            //----------------------------
            if ((*v_ht1200_alpha)[i] < 0.15)
            {
                for_signalflavor_jet(5, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], HT1200Weight, h_DY_JetPt_bjet_cut);
                for_signalflavor_jet(4, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], HT1200Weight, h_DY_JetPt_cjet_cut);
                for_signalflavor_jet(0, (*v_ht1200_Jethadronflavor)[i], (*v_ht1200_JetPt)[i], HT1200Weight, h_DY_JetPt_light_cut);
            }
        }
    }
    ...
    for (int evt = 0; evt < T_tree8->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ht2500_JetPt->size(); i++)
        {
            for_signalflavor_jet(5, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], HT2500Weight, h_DY_JetPt_bjet);
            for_signalflavor_jet(4, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], HT2500Weight, h_DY_JetPt_cjet);
            for_signalflavor_jet(0, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], HT2500Weight, h_DY_JetPt_light);
            //----------------------------
            // apply bin by bin fake rate
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], bin_bjetWeight, h_DY_JetPt_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], bin_cjetWeight, h_DY_JetPt_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], bin_lightjetWeight, h_DY_JetPt_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], rootfit_bjetWeight, h_DY_JetPt_bjet_CR);
            for_signalflavor_jet(4, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], rootfit_cjetWeight, h_DY_JetPt_cjet_CR);
            for_signalflavor_jet(0, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], rootfit_lightjetWeight, h_DY_JetPt_light_CR);
            //----------------------------
            // Signal Region
            //----------------------------
            if ((*v_ht2500_alpha)[i] < 0.15)
            {
                for_signalflavor_jet(5, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], HT2500Weight, h_DY_JetPt_bjet_cut);
                for_signalflavor_jet(4, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], HT2500Weight, h_DY_JetPt_cjet_cut);
                for_signalflavor_jet(0, (*v_ht2500_Jethadronflavor)[i], (*v_ht2500_JetPt)[i], HT2500Weight, h_DY_JetPt_light_cut);
            }
        }
    }
    ...
    h_DY_JetPt_light_CR->GetXaxis()->SetTitle("Jet PT");
    h_DY_JetPt_light_CR->GetXaxis()->SetTitleOffset(1.5);
    ...
    h_DY_JetPt_bjet_CR->GetXaxis()->SetTitle("Jet PT");
    h_DY_JetPt_bjet_CR->GetXaxis()->SetTitleOffset(1.5);
    ...
    TH1D *Ratioresult = (TH1D *)h_DY_JetPt_light_CR->Clone("Ratioresult");
    ...
    h_DY_JetPt_bjet_bybin_CR->SetLineColor(kGreen + 3);
    h_DY_JetPt_cjet_bybin_CR->SetLineColor(kGreen + 3);
    ...
    h_DY_JetPt_light_CR->GetXaxis()->SetRangeUser(0, 250);
    h_DY_JetPt_light_CR->Draw("hist e ");
    h_DY_JetPt_light_bybin_CR->Draw("hist e same");
    h_DY_JetPt_light_cut->Draw("hist e same");
    ...
    l0->Draw();
    gStyle->SetOptStat(0);
    Ratioresult->Divide(h_DY_JetPt_light_CR, h_DY_JetPt_light_cut);
    ...
    {
        double fit_content = h_DY_JetPt_light_CR->GetBinContent(i);
        double MC_content = h_DY_JetPt_light_cut->GetBinContent(i);
    ...
    Ratioresult->SetLineWidth(2);
    Ratioresult->GetXaxis()->SetRangeUser(0, 250);
    Ratioresult->GetYaxis()->SetRangeUser(0, 5);
    Ratioresult->GetYaxis()->SetTitle("Fit / MC");
    Ratioresult->GetXaxis()->SetTitle("Jet PT");
