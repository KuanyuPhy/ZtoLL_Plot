...
void ee_met(TString inputfile = "./DY/ee_DY_Met.root")
{
    ...
    TH1D *HT_Met = ((TH1D *)DYprocess->Get("h_DY_Met_cut"));
    TH1D *Top_Met = ((TH1D *)Topprocess->Get("h_Top_Met_cut"));
    TH1D *Diboson_Met = ((TH1D *)Dibosonprocess->Get("h_diboson_Met_cut"));
    TH1D *Triboson_Met = ((TH1D *)Tribosonprocess->Get("h_triboson_Met_cut"));
