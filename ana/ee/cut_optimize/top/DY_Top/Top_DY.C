...
void Top_DY(TString inputfile = "./../ee_Top_emjet_half.root")
{
    setNCUStyle();
    ...
    */
    c1->cd(1);
    DY_bjet_nTrkfakerate->SetTitle("");
    DY_bjet_nTrkfakerate->GetYaxis()->SetTitle("fake rate");
    DY_bjet_nTrkfakerate->GetXaxis()->SetTitle("Track multiplicity");
    DY_bjet_nTrkfakerate->Draw();
    Top_bjet_nTrkfakerate->Draw("same");
