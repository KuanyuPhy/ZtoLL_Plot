...
void ee_Top_produce_half(TString inputfile = "/home/kuanyu/Documents/root_file/Ztoee/2016BKGMC/top/top_TTTo2L2Nu.root", TString outputfile1 = "./ee_Top_emjet_half.root")
{
    ...
    for (int i = 0; i < 4; i++)
    {
        h_Top_alpha[i] = new TH1D(Form("h_Top_alpha_%d", i + 1), "", 24, 0, 1.2);
        h_Top_alpha[i]->Sumw2();
    }
    ...
    TH1D *h_Top_Chi3Dlog = new TH1D("h_Top_Chi3Dlog", "", 100, -10, 10);
    h_Top_Chi3Dlog->GetXaxis()->SetTitle("");
    h_Top_Chi3Dlog->GetYaxis()->SetTitle("");
    h_Top_Chi3Dlog->Sumw2();

    TH1D *h_Top_IP2D = new TH1D("h_Top_IP2D", "", 200, -20, 20);
    ...
    for (int evt = 0; evt < T_TTTo2L2Nu_tree->GetEntries(); evt++)
    {
        ...
        //---------------------------
        if (v_TTTo2L2Nu_Chi3Dlog->size() != v_TTTo2L2Nu_2DIP->size())
        {
            cout << "bug" << endl;
        }
    ...
    for (int evt = 0; evt < T_ST_tW_top_tree->GetEntries(); evt++)
    {
        ...
        // Track var : 3DSig , 2D IP
        //---------------------------
        if (v_ST_tW_top_Chi3Dlog->size() != v_ST_tW_top_2DIP->size())
        {
            cout << "bug" << endl;
        }
    ...
    for (int evt = 0; evt < T_ST_tW_antitop_tree->GetEntries(); evt++)
    {
        ...
        // Track var : 3DSig , 2D IP
        //---------------------------
        if (v_ST_tW_antitop_Chi3Dlog->size() != v_ST_tW_antitop_2DIP->size())
        {
            cout << "bug" << endl;
        }
    ...
    for (int evt = 0; evt < T_TTWJetsToLNu_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTWJetsToLNu_nTrack->size(); i++)
        {
            ...
            // For heavy flavor
            for_doubleflavor_jet(4, 0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_nTrack)[i], TTWJetsToLNu_eventWeight, h_Top_nTracks_heavy);
            for_doubleflavor_jet(4, 0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetPT)[i], TTWJetsToLNu_eventWeight, h_Top_jetpt_heavy);
            for_doubleflavor_jet(4, 0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_jeteta_heavy);
            for_doubleflavor_jet(4, 0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_alpha)[i], TTWJetsToLNu_eventWeight, h_Top_alpha3D_heavy);
            // For light flavor
            ...
            if ((*v_TTWJetsToLNu_alpha)[i] < 0.15)
            {
                ...
                // For heavy flavor
                for_doubleflavor_jet(4, 0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_nTrack)[i], TTWJetsToLNu_eventWeight, h_Top_nTracks_heavy_cut);
                for_doubleflavor_jet(4, 0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetPT)[i], TTWJetsToLNu_eventWeight, h_Top_jetpt_heavy_cut);
                for_doubleflavor_jet(4, 0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_jeteta_heavy_cut);
                for_doubleflavor_jet(4, 0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_alpha)[i], TTWJetsToLNu_eventWeight, h_Top_alpha3D_heavy_cut);
                // For light flavor
        ...
        // Track var : 3DSig , 2D IP
        //---------------------------
        if (v_TTWJetsToLNu_Chi3Dlog->size() != v_TTWJetsToLNu_2DIP->size())
        {
            cout << "bug" << endl;
        }
    ...
    for (int evt = 0; evt < T_TTWJetsToQQ_tree->GetEntries(); evt++)
    {
        ...
        // Track var : 3DSig , 2D IP
        //---------------------------
        if (v_TTWJetsToQQ_Chi3Dlog->size() != v_TTWJetsToQQ_2DIP->size())
        {
            cout << "bug" << endl;
        }
    ...
    for (int evt = 0; evt < T_TTZToQQ_tree->GetEntries(); evt++)
    {
        ...
        // Track var : 3DSig , 2D IP
        //---------------------------
        if (v_TTZToQQ_Chi3Dlog->size() != v_TTZToQQ_2DIP->size())
        {
            cout << "bug" << endl;
        }
    ...
    for (int evt = 0; evt < T_TTZToLLNuNu_tree->GetEntries(); evt++)
    {
        ...
        // Track var : 3DSig , 2D IP
        //---------------------------
        if (v_TTZToLLNuNu_Chi3Dlog->size() != v_TTZToLLNuNu_2DIP->size())
        {
            cout << "bug" << endl;
        }
    ...
    // Fake rate : nTracks
    //-----------------------
    TH1D *Top_fakeRate = (TH1D *)h_Top_nTracks_cut->Clone("Top_fakeRate");
    Top_fakeRate->Divide(h_Top_nTracks_cut, h_Top_nTracks, 1, 1, "b");
    TH1D *Top_heavy_fakeRate = (TH1D *)h_Top_nTracks_heavy_cut->Clone("Top_heavy_fakeRate");
    Top_heavy_fakeRate->Divide(h_Top_nTracks_heavy_cut, h_Top_nTracks_heavy, 1, 1, "b");
    TH1D *Top_bjet_fakeRate = (TH1D *)h_Top_nTracks_bjet_cut->Clone("Top_bjet_fakeRate");
    Top_bjet_fakeRate->Divide(h_Top_nTracks_bjet_cut, h_Top_nTracks_bjet, 1, 1, "b");
    TH1D *Top_cjet_fakeRate = (TH1D *)h_Top_nTracks_cjet_cut->Clone("Top_cjet_fakeRate");
    Top_cjet_fakeRate->Divide(h_Top_nTracks_cjet_cut, h_Top_nTracks_cjet, 1, 1, "b");
    TH1D *Top_light_fakeRate = (TH1D *)h_Top_nTracks_light_cut->Clone("Top_light_fakeRate");
    ...
    // Jet PT
    //-----------------
    TH1D *Top_lightPT_fakeRate = (TH1D *)h_Top_jetpt_light_cut->Clone("Top_lightPT_fakeRate");
    ...
    TH1D *Top_cjetPT_fakeRate = (TH1D *)h_Top_jetpt_cjet_cut->Clone("Top_cjetPT_fakeRate");
    ...
    // Jet Eta
    //-----------------
    TH1D *Top_lightEta_fakeRate = (TH1D *)h_Top_jeteta_light_cut->Clone("Top_lightEta_fakeRate");
    ...
    TH1D *Top_bjetEta_fakeRate = (TH1D *)h_Top_jeteta_bjet_cut->Clone("Top_bjetEta_fakeRate");
    ...
    TH1D *Top_cjetEta_fakeRate = (TH1D *)h_Top_jeteta_cjet_cut->Clone("Top_cjetEta_fakeRate");
