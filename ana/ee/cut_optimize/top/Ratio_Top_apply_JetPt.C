...
void Ratio_Top_apply_JetPt()
{
    ...
    TH1D *h_Top_JetPT_CR = new TH1D("h_Top_JetPT_CR", "", 50, 0, 500);
    ...
    TH1D *h_Top_JetPT_heavy_CR = new TH1D("h_Top_JetPT_heavy_CR", "", 50, 0, 500);
    ...
    TH1D *h_Top_JetPT_bjet_bybin_CR = new TH1D("h_Top_JetPT_bjet_bybin_CR", "", 50, 0, 500);
    ...
    TH1D *h_Top_JetPT_cjet_bybin_CR = new TH1D("h_Top_JetPT_cjet_bybin_CR", "", 50, 0, 500);
    ...
    TH1D *h_Top_JetPT_light_CR = new TH1D("h_Top_JetPT_light_CR", "", 50, 0, 500);
    h_Top_JetPT_light_CR->GetXaxis()->SetTitle("");
    h_Top_JetPT_light_CR->GetYaxis()->SetTitle("");
    h_Top_JetPT_light_CR->Sumw2();

    TH1D *h_Top_JetPT_light_bybin_CR = new TH1D("h_Top_JetPT_light_bybin_CR", "", 50, 0, 500);
    ...
    for (int evt = 0; evt < T_TTTo2L2Nu_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTTo2L2Nu_JetPT->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetPT)[i], bWeightbybin, h_Top_JetPT_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetPT)[i], cWeightbybin, h_Top_JetPT_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetPT)[i], lightWeightbybin, h_Top_JetPT_light_bybin_CR);
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetPT)[i], rootfit_bjetWeight, h_Top_JetPT_bjet_CR);
            for_signalflavor_jet(4, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetPT)[i], rootfit_cjetWeight, h_Top_JetPT_cjet_CR);
            for_signalflavor_jet(0, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetPT)[i], rootfit_lightjetWeight, h_Top_JetPT_light_CR);
    ...
    for (int evt = 0; evt < T_ST_tW_top_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ST_tW_top_JetPT->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetPT)[i], bWeightbybin, h_Top_JetPT_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetPT)[i], cWeightbybin, h_Top_JetPT_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetPT)[i], lightWeightbybin, h_Top_JetPT_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetPT)[i], rootfit_bjetWeight, h_Top_JetPT_bjet_CR);
            for_signalflavor_jet(4, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetPT)[i], rootfit_cjetWeight, h_Top_JetPT_cjet_CR);
            for_signalflavor_jet(0, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetPT)[i], rootfit_lightjetWeight, h_Top_JetPT_light_CR);
    ...
    for (int evt = 0; evt < T_ST_tW_antitop_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ST_tW_antitop_JetPT->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetPT)[i], bWeightbybin, h_Top_JetPT_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetPT)[i], cWeightbybin, h_Top_JetPT_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetPT)[i], lightWeightbybin, h_Top_JetPT_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetPT)[i], rootfit_bjetWeight, h_Top_JetPT_bjet_CR);
            for_signalflavor_jet(4, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetPT)[i], rootfit_cjetWeight, h_Top_JetPT_cjet_CR);
            for_signalflavor_jet(0, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetPT)[i], rootfit_lightjetWeight, h_Top_JetPT_light_CR);
    ...
    for (int evt = 0; evt < T_TTWJetsToLNu_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTWJetsToLNu_JetPT->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetPT)[i], bWeightbybin, h_Top_JetPT_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetPT)[i], cWeightbybin, h_Top_JetPT_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetPT)[i], lightWeightbybin, h_Top_JetPT_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetPT)[i], rootfit_bjetWeight, h_Top_JetPT_bjet_CR);
            for_signalflavor_jet(4, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetPT)[i], rootfit_cjetWeight, h_Top_JetPT_cjet_CR);
            for_signalflavor_jet(0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetPT)[i], rootfit_lightjetWeight, h_Top_JetPT_light_CR);
    ...
    for (int evt = 0; evt < T_TTWJetsToQQ_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTWJetsToQQ_JetPT->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetPT)[i], bWeightbybin, h_Top_JetPT_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetPT)[i], cWeightbybin, h_Top_JetPT_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetPT)[i], lightWeightbybin, h_Top_JetPT_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetPT)[i], rootfit_bjetWeight, h_Top_JetPT_bjet_CR);
            for_signalflavor_jet(4, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetPT)[i], rootfit_cjetWeight, h_Top_JetPT_cjet_CR);
            for_signalflavor_jet(0, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetPT)[i], rootfit_lightjetWeight, h_Top_JetPT_light_CR);
    ...
    for (int evt = 0; evt < T_TTZToQQ_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTZToQQ_JetPT->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetPT)[i], bWeightbybin, h_Top_JetPT_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetPT)[i], cWeightbybin, h_Top_JetPT_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetPT)[i], lightWeightbybin, h_Top_JetPT_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetPT)[i], rootfit_bjetWeight, h_Top_JetPT_bjet_CR);
            for_signalflavor_jet(4, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetPT)[i], rootfit_cjetWeight, h_Top_JetPT_cjet_CR);
            for_signalflavor_jet(0, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetPT)[i], rootfit_lightjetWeight, h_Top_JetPT_light_CR);
    ...
    for (int evt = 0; evt < T_TTZToLLNuNu_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTZToLLNuNu_JetPT->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetPT)[i], bWeightbybin, h_Top_JetPT_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetPT)[i], cWeightbybin, h_Top_JetPT_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetPT)[i], lightWeightbybin, h_Top_JetPT_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            ...
            for_signalflavor_jet(5, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetPT)[i], rootfit_bjetWeight, h_Top_JetPT_bjet_CR);
            for_signalflavor_jet(4, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetPT)[i], rootfit_cjetWeight, h_Top_JetPT_cjet_CR);
            for_signalflavor_jet(0, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetPT)[i], rootfit_lightjetWeight, h_Top_JetPT_light_CR);
