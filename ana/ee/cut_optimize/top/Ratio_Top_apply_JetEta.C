...
Double_t bjet_background(float_t x)
{
...
void Ratio_Top_apply_JetEta()
{
    ...
    //  nTracks
    //-------------
    TH1D *h_Top_JetEta = new TH1D("h_Top_JetEta", "",15., -5., 5.);
    h_Top_JetEta->GetXaxis()->SetTitle("");
    h_Top_JetEta->GetYaxis()->SetTitle("");
    h_Top_JetEta->Sumw2();

    TH1D *h_Top_JetEta_cut = new TH1D("h_Top_JetEta_cut", "",15., -5., 5.);
    h_Top_JetEta_cut->GetXaxis()->SetTitle("");
    h_Top_JetEta_cut->GetYaxis()->SetTitle("");
    h_Top_JetEta_cut->Sumw2();

    TH1D *h_Top_JetEta_CR = new TH1D("h_Top_JetEta_CR", "",15., -5., 5.);
    h_Top_JetEta_CR->GetXaxis()->SetTitle("");
    h_Top_JetEta_CR->GetYaxis()->SetTitle("");
    h_Top_JetEta_CR->Sumw2();

    TH1D *h_Top_JetEta_heavy = new TH1D("h_Top_JetEta_heavy", "",15., -5., 5.);
    h_Top_JetEta_heavy->GetXaxis()->SetTitle("");
    h_Top_JetEta_heavy->GetYaxis()->SetTitle("");
    h_Top_JetEta_heavy->Sumw2();

    TH1D *h_Top_JetEta_heavy_cut = new TH1D("h_Top_JetEta_heavy_cut", "",15., -5., 5.);
    h_Top_JetEta_heavy_cut->GetXaxis()->SetTitle("");
    h_Top_JetEta_heavy_cut->GetYaxis()->SetTitle("");
    h_Top_JetEta_heavy_cut->Sumw2();

    TH1D *h_Top_JetEta_heavy_CR = new TH1D("h_Top_JetEta_heavy_CR", "",15., -5., 5.);
    h_Top_JetEta_heavy_CR->GetXaxis()->SetTitle("");
    h_Top_JetEta_heavy_CR->GetYaxis()->SetTitle("");
    h_Top_JetEta_heavy_CR->Sumw2();

    TH1D *h_Top_JetEta_bjet = new TH1D("h_Top_JetEta_bjet", "",15., -5., 5.);
    h_Top_JetEta_bjet->GetXaxis()->SetTitle("");
    h_Top_JetEta_bjet->GetYaxis()->SetTitle("");
    h_Top_JetEta_bjet->Sumw2();

    TH1D *h_Top_JetEta_bjet_cut = new TH1D("h_Top_JetEta_bjet_cut", "",15., -5., 5.);
    h_Top_JetEta_bjet_cut->GetXaxis()->SetTitle("");
    h_Top_JetEta_bjet_cut->GetYaxis()->SetTitle("");
    h_Top_JetEta_bjet_cut->Sumw2();

    TH1D *h_Top_JetEta_bjet_CR = new TH1D("h_Top_JetEta_bjet_CR", "",15., -5., 5.);
    h_Top_JetEta_bjet_CR->GetXaxis()->SetTitle("");
    h_Top_JetEta_bjet_CR->GetYaxis()->SetTitle("");
    h_Top_JetEta_bjet_CR->Sumw2();

    TH1D *h_Top_JetEta_bjet_bybin_CR = new TH1D("h_Top_JetEta_bjet_bybin_CR", "",15., -5., 5.);
    h_Top_JetEta_bjet_bybin_CR->GetXaxis()->SetTitle("");
    h_Top_JetEta_bjet_bybin_CR->GetYaxis()->SetTitle("");
    h_Top_JetEta_bjet_bybin_CR->Sumw2();

    TH1D *h_Top_JetEta_cjet = new TH1D("h_Top_JetEta_cjet", "",15., -5., 5.);
    h_Top_JetEta_cjet->GetXaxis()->SetTitle("");
    h_Top_JetEta_cjet->GetYaxis()->SetTitle("");
    h_Top_JetEta_cjet->Sumw2();

    TH1D *h_Top_JetEta_cjet_cut = new TH1D("h_Top_JetEta_cjet_cut", "",15., -5., 5.);
    h_Top_JetEta_cjet_cut->GetXaxis()->SetTitle("");
    h_Top_JetEta_cjet_cut->GetYaxis()->SetTitle("");
    h_Top_JetEta_cjet_cut->Sumw2();

    TH1D *h_Top_JetEta_cjet_CR = new TH1D("h_Top_JetEta_cjet_CR", "",15., -5., 5.);
    h_Top_JetEta_cjet_CR->GetXaxis()->SetTitle("");
    h_Top_JetEta_cjet_CR->GetYaxis()->SetTitle("");
    h_Top_JetEta_cjet_CR->Sumw2();

    TH1D *h_Top_JetEta_cjet_bybin_CR = new TH1D("h_Top_JetEta_cjet_bybin_CR", "",15., -5., 5.);
    h_Top_JetEta_cjet_bybin_CR->GetXaxis()->SetTitle("");
    h_Top_JetEta_cjet_bybin_CR->GetYaxis()->SetTitle("");
    h_Top_JetEta_cjet_bybin_CR->Sumw2();

    TH1D *h_Top_JetEta_light = new TH1D("h_Top_JetEta_light", "",15., -5., 5.);
    h_Top_JetEta_light->GetXaxis()->SetTitle("");
    h_Top_JetEta_light->GetYaxis()->SetTitle("");
    h_Top_JetEta_light->Sumw2();

    TH1D *h_Top_JetEta_light_cut = new TH1D("h_Top_JetEta_light_cut", "",15., -5., 5.);
    h_Top_JetEta_light_cut->GetXaxis()->SetTitle("");
    h_Top_JetEta_light_cut->GetYaxis()->SetTitle("");
    h_Top_JetEta_light_cut->Sumw2();

    TH1D *h_Top_JetEta_light_CR = new TH1D("h_Top_JetEta_light_CR", "",15., -5., 5.);
    h_Top_JetEta_light_CR->GetXaxis()->SetTitle("");
    h_Top_JetEta_light_CR->GetYaxis()->SetTitle("");
    h_Top_JetEta_light_CR->Sumw2();

    TH1D *h_Top_JetEta_light_bybin_CR = new TH1D("h_Top_JetEta_light_bybin_CR", "",15., -5., 5.);
    h_Top_JetEta_light_bybin_CR->GetXaxis()->SetTitle("");
    h_Top_JetEta_light_bybin_CR->GetYaxis()->SetTitle("");
    h_Top_JetEta_light_bybin_CR->Sumw2();
    ...
    for (int evt = 0; evt < T_TTTo2L2Nu_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTTo2L2Nu_JetEta->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], bWeightbybin, h_Top_JetEta_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], cWeightbybin, h_Top_JetEta_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], lightWeightbybin, h_Top_JetEta_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            double rootfit_bjetWeight = bjet_background((*v_TTTo2L2Nu_nTrack)[i]) * TTTo2L2Nu_eventWeight;
            double rootfit_cjetWeight = cjet_background((*v_TTTo2L2Nu_nTrack)[i]) * TTTo2L2Nu_eventWeight;
            double rootfit_lightjetWeight = lightjet_background((*v_TTTo2L2Nu_nTrack)[i]) * TTTo2L2Nu_eventWeight;
            for_signalflavor_jet(5, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], rootfit_bjetWeight, h_Top_JetEta_bjet_CR);
            for_signalflavor_jet(4, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], rootfit_cjetWeight, h_Top_JetEta_cjet_CR);
            for_signalflavor_jet(0, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], rootfit_lightjetWeight, h_Top_JetEta_light_CR);
    ...
    for (int evt = 0; evt < T_ST_tW_top_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ST_tW_top_JetEta->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], bWeightbybin, h_Top_JetEta_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], cWeightbybin, h_Top_JetEta_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], lightWeightbybin, h_Top_JetEta_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            double rootfit_bjetWeight = bjet_background((*v_ST_tW_top_nTrack)[i]) * ST_tW_top_eventWeight;
            double rootfit_cjetWeight = cjet_background((*v_ST_tW_top_nTrack)[i]) * ST_tW_top_eventWeight;
            double rootfit_lightjetWeight = lightjet_background((*v_ST_tW_top_nTrack)[i]) * ST_tW_top_eventWeight;
            for_signalflavor_jet(5, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], rootfit_bjetWeight, h_Top_JetEta_bjet_CR);
            for_signalflavor_jet(4, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], rootfit_cjetWeight, h_Top_JetEta_cjet_CR);
            for_signalflavor_jet(0, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], rootfit_lightjetWeight, h_Top_JetEta_light_CR);
            // cout << "eta = "<<(*v_ST_tW_top_JetEta)[i]<<endl;
    ...
    for (int evt = 0; evt < T_ST_tW_antitop_tree->GetEntries(); evt++)
    {
        ...
        if (v_ST_tW_antitop_JetEta->size() != v_ST_tW_antitop_Jethadronflavor->size())
        {

            cout << "bug" << endl;
            cout << "Jet Eta size =" << v_ST_tW_antitop_JetEta->size() << endl;
            cout << "Jet Jethadronflavor size =" << v_ST_tW_antitop_Jethadronflavor->size() << endl;
        }
        for (size_t i = 0; i < v_ST_tW_antitop_JetEta->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], bWeightbybin, h_Top_JetEta_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], cWeightbybin, h_Top_JetEta_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], lightWeightbybin, h_Top_JetEta_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            double rootfit_bjetWeight = bjet_background((*v_ST_tW_antitop_nTrack)[i]) * ST_tW_antitop_eventWeight;
            double rootfit_cjetWeight = cjet_background((*v_ST_tW_antitop_nTrack)[i]) * ST_tW_antitop_eventWeight;
            double rootfit_lightjetWeight = lightjet_background((*v_ST_tW_antitop_nTrack)[i]) * ST_tW_antitop_eventWeight;
            for_signalflavor_jet(5, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], rootfit_bjetWeight, h_Top_JetEta_bjet_CR);
            if ((*v_ST_tW_antitop_Jethadronflavor)[i] == 5)
            {
                cout << "eta = " << (*v_ST_tW_top_JetEta)[i] << endl;
            }
            for_signalflavor_jet(4, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], rootfit_cjetWeight, h_Top_JetEta_cjet_CR);
            for_signalflavor_jet(0, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], rootfit_lightjetWeight, h_Top_JetEta_light_CR);
    ...
    for (int evt = 0; evt < T_TTWJetsToLNu_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTWJetsToLNu_JetEta->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], bWeightbybin, h_Top_JetEta_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], cWeightbybin, h_Top_JetEta_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], lightWeightbybin, h_Top_JetEta_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            double rootfit_bjetWeight = bjet_background((*v_TTWJetsToLNu_nTrack)[i]) * TTWJetsToLNu_eventWeight;
            double rootfit_cjetWeight = cjet_background((*v_TTWJetsToLNu_nTrack)[i]) * TTWJetsToLNu_eventWeight;
            double rootfit_lightjetWeight = lightjet_background((*v_TTWJetsToLNu_nTrack)[i]) * TTWJetsToLNu_eventWeight;
            for_signalflavor_jet(5, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], rootfit_bjetWeight, h_Top_JetEta_bjet_CR);
            for_signalflavor_jet(4, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], rootfit_cjetWeight, h_Top_JetEta_cjet_CR);
            for_signalflavor_jet(0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], rootfit_lightjetWeight, h_Top_JetEta_light_CR);
    ...
    for (int evt = 0; evt < T_TTWJetsToQQ_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTWJetsToQQ_JetEta->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], bWeightbybin, h_Top_JetEta_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], cWeightbybin, h_Top_JetEta_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], lightWeightbybin, h_Top_JetEta_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            double rootfit_bjetWeight = bjet_background((*v_TTWJetsToQQ_nTrack)[i]) * TTWJetsToQQ_eventWeight;
            double rootfit_cjetWeight = cjet_background((*v_TTWJetsToQQ_nTrack)[i]) * TTWJetsToQQ_eventWeight;
            double rootfit_lightjetWeight = lightjet_background((*v_TTWJetsToQQ_nTrack)[i]) * TTWJetsToQQ_eventWeight;
            for_signalflavor_jet(5, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], rootfit_bjetWeight, h_Top_JetEta_bjet_CR);
            for_signalflavor_jet(4, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], rootfit_cjetWeight, h_Top_JetEta_cjet_CR);
            for_signalflavor_jet(0, (*v_TTWJetsToQQ_Jethadronflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], rootfit_lightjetWeight, h_Top_JetEta_light_CR);
    ...
    for (int evt = 0; evt < T_TTZToQQ_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTZToQQ_JetEta->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], bWeightbybin, h_Top_JetEta_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], cWeightbybin, h_Top_JetEta_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], lightWeightbybin, h_Top_JetEta_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            double rootfit_bjetWeight = bjet_background((*v_TTZToQQ_nTrack)[i]) * TTZToQQ_eventWeight;
            double rootfit_cjetWeight = cjet_background((*v_TTZToQQ_nTrack)[i]) * TTZToQQ_eventWeight;
            double rootfit_lightjetWeight = lightjet_background((*v_TTZToQQ_nTrack)[i]) * TTZToQQ_eventWeight;
            for_signalflavor_jet(5, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], rootfit_bjetWeight, h_Top_JetEta_bjet_CR);
            for_signalflavor_jet(4, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], rootfit_cjetWeight, h_Top_JetEta_cjet_CR);
            for_signalflavor_jet(0, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], rootfit_lightjetWeight, h_Top_JetEta_light_CR);
    ...
    for (int evt = 0; evt < T_TTZToLLNuNu_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTZToLLNuNu_JetEta->size(); i++)
        {
            ...
            for_signalflavor_jet(5, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], bWeightbybin, h_Top_JetEta_bjet_bybin_CR);
            for_signalflavor_jet(4, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], cWeightbybin, h_Top_JetEta_cjet_bybin_CR);
            for_signalflavor_jet(0, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], lightWeightbybin, h_Top_JetEta_light_bybin_CR);
            //----------------------------
            // apply fit fake rate curve
            //----------------------------
            double rootfit_bjetWeight = bjet_background((*v_TTZToLLNuNu_nTrack)[i]) * TTZToLLNuNu_eventWeight;
            double rootfit_cjetWeight = cjet_background((*v_TTZToLLNuNu_nTrack)[i]) * TTZToLLNuNu_eventWeight;
            double rootfit_lightjetWeight = lightjet_background((*v_TTZToLLNuNu_nTrack)[i]) * TTZToLLNuNu_eventWeight;
            for_signalflavor_jet(5, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], rootfit_bjetWeight, h_Top_JetEta_bjet_CR);
            for_signalflavor_jet(4, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], rootfit_cjetWeight, h_Top_JetEta_cjet_CR);
            for_signalflavor_jet(0, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], rootfit_lightjetWeight, h_Top_JetEta_light_CR);
    ...
    h_Top_JetEta_light_bybin_CR->SetLineWidth(2);
    h_Top_JetEta_light_cut->SetTitle("light jet (Top)");
    h_Top_JetEta_light_bybin_CR->SetTitle("light jet (Top)");
    h_Top_JetEta_light_cut->GetYaxis()->SetTitle("nJet");
    h_Top_JetEta_light_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    ...
    h_Top_JetEta_light_CR->GetYaxis()->SetTitle("nJet");
    ...
    h_Top_JetEta_bjet_bybin_CR->SetLineWidth(2);
    // h_Top_JetEta_bjet_bybin_CR->SetTitle("b jet (Top)");
    h_Top_JetEta_bjet_cut->SetTitle("b jet (Top)");
    h_Top_JetEta_bjet_cut->GetYaxis()->SetTitle("nJet");
    h_Top_JetEta_bjet_bybin_CR->GetYaxis()->SetTitle("nJet");
    h_Top_JetEta_bjet_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_JetEta_bjet_cut->GetXaxis()->SetTitle("Jet #eta");
    h_Top_JetEta_bjet_cut->GetXaxis()->SetTitleOffset(1.5);

    // h_Top_JetEta_bjet_CR->SetTitle("b jet (Top)");
    h_Top_JetEta_bjet_CR->GetYaxis()->SetTitle("nJet");
    h_Top_JetEta_bjet_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_JetEta_bjet_CR->GetXaxis()->SetTitleOffset(1.5);

    h_Top_JetEta_cjet_cut->SetLineWidth(2);
    h_Top_JetEta_cjet_CR->SetLineWidth(2);
    h_Top_JetEta_cjet_bybin_CR->SetLineWidth(2);
    // h_Top_JetEta_cjet_cut->SetTitle("c jet (Top)");
    h_Top_JetEta_cjet_bybin_CR->SetTitle("c jet (Top)");
    h_Top_JetEta_cjet_cut->GetYaxis()->SetTitle("nJet");
    h_Top_JetEta_cjet_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_JetEta_cjet_cut->GetXaxis()->SetTitle("Jet #eta");
    h_Top_JetEta_cjet_cut->GetXaxis()->SetTitleOffset(1.5);

    // h_Top_JetEta_cjet_CR->SetTitle("c jet (Top)");
    h_Top_JetEta_cjet_CR->GetYaxis()->SetTitle("nJet");
    h_Top_JetEta_cjet_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_JetEta_cjet_CR->GetXaxis()->SetTitleOffset(1.5);
    ...
    TH1D *Ratioresult = (TH1D *)h_Top_JetEta_light_CR->Clone("Ratioresult");

    h_Top_JetEta_cjet_CR->SetLineColor(kRed);
    h_Top_JetEta_bjet_CR->SetLineColor(kRed);
    h_Top_JetEta_light_CR->SetLineColor(kRed);

    h_Top_JetEta_cjet_CR->SetLabelSize(0);
    h_Top_JetEta_bjet_CR->SetLabelSize(0);
    h_Top_JetEta_light_CR->SetLabelSize(0);

    h_Top_JetEta_cjet_cut->SetLabelSize(0);

    h_Top_JetEta_bjet_bybin_CR->SetLineColor(kGreen + 3);
    h_Top_JetEta_cjet_bybin_CR->SetLineColor(kGreen + 3);
    h_Top_JetEta_light_bybin_CR->SetLineColor(kGreen + 3);
    // h_Top_JetEta_bjet_cut->SetLabelSize(0);
    // h_Top_JetEta_cjet_cut->SetLabelSize(0);
    // h_Top_JetEta_light_cut->SetLabelSize(0);
    // h_Top_JetEta_light_cut->SetLabelSize(0);
    // h_Top_JetEta_light_CR->SetLabelSize(0);
    // h_Top_JetEta_cjet_CR->SetLabelSize(0);
    // h_Top_JetEta_bjet_CR->SetLabelSize(0);
    // h_Top_JetEta_bjet_bybin_CR->SetLabelSize(0);
    // h_Top_JetEta_bjet_bybin_CR->GetXaxis()->SetRangeUser(0, 200);
    h_Top_JetEta_light_CR->Draw("hist e ");
    //h_Top_JetEta_light_cut->Draw("hist e same");
    //h_Top_JetEta_light_bybin_CR->Draw("hist e same");

    TLegend *l0 = new TLegend(0.7, 0.6, 0.90, 0.80);
    l0->SetHeader("Top process (b Jet)");
    l0->SetBorderSize(0);
    l0->SetTextSize(0.03);
    l0->AddEntry(h_Top_JetEta_bjet_cut, "Top SR", "l");
    l0->AddEntry(h_Top_JetEta_bjet_CR, "Top apply fit result", "l");
    l0->AddEntry(h_Top_JetEta_bjet_bybin_CR, "Top apply bin by bin result", "l");
    // l0->Draw();
    gStyle->SetOptStat(0);
    gStyle->SetOptStat(0);
    Ratioresult->Divide(h_Top_JetEta_light_CR, h_Top_JetEta_light_cut);
    ...
    Ratioresult->GetYaxis()->SetRangeUser(-0.5, 3);
    Ratioresult->Draw();
    /*
    c1->cd(2);
    gStyle->SetStatW(0.3);
    ...
    gPad->SetBottomMargin(0.2);
    gPad->SetTickx();
    TH1D *Ratioresult = new TH1D("Ratioresult", "",15., -5., 5.);
    Ratioresult->Sumw2();
    int nBins = h_Top_JetEta_bjet_cut->GetNbinsX();
    for (int i = 1; i <= nBins; i++)
    {
        double fit_content = h_Top_JetEta_bjet_CR->GetBinContent(i);
        double MC_content = h_Top_JetEta_bjet_cut->GetBinContent(i);
    ...
    //Ratioresult->GetXaxis()->SetRangeUser(0, 200);
    Ratioresult->Draw("E1");
    */
    gStyle->SetOptStat(0);
}
