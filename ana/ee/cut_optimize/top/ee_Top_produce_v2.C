...
using namespace std;
void ee_Top_produce_v2(TString inputfile = "./../../../../../../root_file/Ztoee/2016BKGMC/top/top_TTTo2L2Nu.root", TString outputfile1 = "./ee_Top_emjet.root")
{
    ...
    TH1F *h_Top_nTracks_exclu_bjet = new TH1F("h_Top_nTracks_exclu_bjet", "", 50, 0, 50);
    h_Top_nTracks_exclu_bjet->GetXaxis()->SetTitle("");
    h_Top_nTracks_exclu_bjet->GetYaxis()->SetTitle("");
    h_Top_nTracks_exclu_bjet->Sumw2();
    ...
    TH1F *h_Top_nTracks_exclu_bjet_cut = new TH1F("h_Top_nTracks_exclu_bjet_cut", "", 50, 0, 50);
    h_Top_nTracks_exclu_bjet_cut->GetXaxis()->SetTitle("");
    h_Top_nTracks_exclu_bjet_cut->GetYaxis()->SetTitle("");
    h_Top_nTracks_exclu_bjet_cut->Sumw2();
    ...
    for (int evt = 0; evt < T_TTTo2L2Nu_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_alpha[0]->Fill((*v_TTTo2L2Nu_alpha)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
        }
        for (size_t i = 0; i < v_TTTo2L2Nu_alpha2->size(); i++)
        {
            h_Top_alpha[1]->Fill((*v_TTTo2L2Nu_alpha2)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
        }
        for (size_t i = 0; i < v_TTTo2L2Nu_alpha3->size(); i++)
        {
            h_Top_alpha[2]->Fill((*v_TTTo2L2Nu_alpha3)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
        }
        for (size_t i = 0; i < v_TTTo2L2Nu_alpha4->size(); i++)
        {
            h_Top_alpha[3]->Fill((*v_TTTo2L2Nu_alpha4)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
        }
        //----------
        //  3DSig
        //----------
        ...
        {
            h_Top_Chi3Dlog->Fill((*v_TTTo2L2Nu_Chi3Dlog)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
        }
        for (size_t i = 0; i < v_TTTo2L2Nu_nTrack->size(); i++)
        {
            h_Top_nTracks->Fill((*v_TTTo2L2Nu_nTrack)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
            if ((*v_TTTo2L2Nu_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_bjet->Fill((*v_TTTo2L2Nu_nTrack)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
            }
            else
            {
               h_Top_nTracks_exclu_bjet->Fill((*v_TTTo2L2Nu_nTrack)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
            }

            if ((*v_TTTo2L2Nu_Jethadronflavor)[i] == 4 || (*v_TTTo2L2Nu_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_heavy->Fill((*v_TTTo2L2Nu_nTrack)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
            }
            else
            {
                h_Top_nTracks_light->Fill((*v_TTTo2L2Nu_nTrack)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
            }
            if ((*v_TTTo2L2Nu_alpha)[i] < 0.15)
            {

                h_Top_nTracks_cut->Fill((*v_TTTo2L2Nu_nTrack)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
                if ((*v_TTTo2L2Nu_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_bjet_cut->Fill((*v_TTTo2L2Nu_nTrack)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
                }
                else
                {
                   h_Top_nTracks_exclu_bjet_cut->Fill((*v_TTTo2L2Nu_nTrack)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
                }
                if ((*v_TTTo2L2Nu_Jethadronflavor)[i] == 4 || (*v_TTTo2L2Nu_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_heavy_cut->Fill((*v_TTTo2L2Nu_nTrack)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
                }
                else
                {
                    h_Top_nTracks_light_cut->Fill((*v_TTTo2L2Nu_nTrack)[i], I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
                }
            } // alpha cut
        }
    } // End of TTTo2L2Nu
    ...
    for (int evt = 0; evt < T_ST_tW_top_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_alpha[0]->Fill((*v_ST_tW_top_alpha)[i], I_ST_tW_top_weight * ST_tW_topWeight);
        }
        for (size_t i = 0; i < v_ST_tW_top_alpha2->size(); i++)
        {
            h_Top_alpha[1]->Fill((*v_ST_tW_top_alpha2)[i], I_ST_tW_top_weight * ST_tW_topWeight);
        }
        for (size_t i = 0; i < v_ST_tW_top_alpha3->size(); i++)
        {
            h_Top_alpha[2]->Fill((*v_ST_tW_top_alpha3)[i], I_ST_tW_top_weight * ST_tW_topWeight);
        }
        for (size_t i = 0; i < v_ST_tW_top_alpha4->size(); i++)
        {
            h_Top_alpha[3]->Fill((*v_ST_tW_top_alpha4)[i], I_ST_tW_top_weight * ST_tW_topWeight);
        }
        //----------
        //  3DSig
        //----------
        ...
        {
            h_Top_Chi3Dlog->Fill((*v_ST_tW_top_Chi3Dlog)[i], I_ST_tW_top_weight * ST_tW_topWeight);
        }
        //----------------
        // Jet Pt, Jet Eta
        //----------------
        for (size_t i = 0; i < v_ST_tW_top_JetPT->size(); i++)
        {
            if ((*v_ST_tW_top_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_bjet->Fill((*v_ST_tW_top_JetPT)[i], I_ST_tW_top_weight * ST_tW_topWeight);
            }
            if ((*v_ST_tW_top_Jethadronflavor)[i] == 4 || (*v_ST_tW_top_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_heavy->Fill((*v_ST_tW_top_JetPT)[i], I_ST_tW_top_weight * ST_tW_topWeight);
            }
            else
            {
                h_Top_jetpt_heavy->Fill((*v_ST_tW_top_JetPT)[i], I_ST_tW_top_weight * ST_tW_topWeight);
        ...
        for (size_t i = 0; i < v_TTZToQQ_JetEta->size(); i++)
        {
            if ((*v_ST_tW_top_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_bjet->Fill((*v_TTZToQQ_JetEta)[i], I_ST_tW_top_weight * ST_tW_topWeight);
            }

            if ((*v_ST_tW_top_Jethadronflavor)[i] == 4 || (*v_ST_tW_top_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_heavy->Fill((*v_TTZToQQ_JetEta)[i], I_ST_tW_top_weight * ST_tW_topWeight);
            }
            else
            {
                h_Top_jeteta_heavy->Fill((*v_TTZToQQ_JetEta)[i], I_ST_tW_top_weight * ST_tW_topWeight);
        ...
        {
            h_Top_nTracks->Fill((*v_ST_tW_top_nTrack)[i], I_ST_tW_top_weight * ST_tW_topWeight);
            if ((*v_ST_tW_top_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_bjet->Fill((*v_ST_tW_top_nTrack)[i], I_ST_tW_top_weight * ST_tW_topWeight);
            }
            else
            {
                h_Top_nTracks_exclu_bjet->Fill((*v_ST_tW_top_nTrack)[i], I_ST_tW_top_weight * ST_tW_topWeight);
            }
            if ((*v_ST_tW_top_Jethadronflavor)[i] == 4 || (*v_ST_tW_top_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_heavy->Fill((*v_ST_tW_top_nTrack)[i], I_ST_tW_top_weight * ST_tW_topWeight);
            }
            else
            {
                h_Top_nTracks_light->Fill((*v_ST_tW_top_nTrack)[i], I_ST_tW_top_weight * ST_tW_topWeight);
            }
            if ((*v_ST_tW_top_alpha)[i] < 0.15)
            {
                h_Top_nTracks_cut->Fill((*v_ST_tW_top_nTrack)[i], I_ST_tW_top_weight * ST_tW_topWeight);
                if ((*v_ST_tW_top_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_bjet_cut->Fill((*v_ST_tW_top_nTrack)[i], I_ST_tW_top_weight * ST_tW_topWeight);
                }
                else
                {
                    h_Top_nTracks_exclu_bjet_cut->Fill((*v_ST_tW_top_nTrack)[i], I_ST_tW_top_weight * ST_tW_topWeight);
                }
                if ((*v_ST_tW_top_Jethadronflavor)[i] == 4 || (*v_ST_tW_top_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_heavy_cut->Fill((*v_ST_tW_top_nTrack)[i], I_ST_tW_top_weight * ST_tW_topWeight);
                }
                else
                {
                    h_Top_nTracks_light_cut->Fill((*v_ST_tW_top_nTrack)[i], I_ST_tW_top_weight * ST_tW_topWeight);
                }
            } // alpha cut
        }
    ...
    for (int evt = 0; evt < T_ST_tW_antitop_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_alpha[0]->Fill((*v_ST_tW_antitop_alpha)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        }
        for (size_t i = 0; i < v_ST_tW_antitop_alpha2->size(); i++)
        {
            h_Top_alpha[1]->Fill((*v_ST_tW_antitop_alpha2)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        }
        for (size_t i = 0; i < v_ST_tW_antitop_alpha3->size(); i++)
        {
            h_Top_alpha[2]->Fill((*v_ST_tW_antitop_alpha3)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        }
        for (size_t i = 0; i < v_ST_tW_antitop_alpha4->size(); i++)
        {
            h_Top_alpha[3]->Fill((*v_ST_tW_antitop_alpha4)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        }
        //----------
        //  3DSig
        //----------
        ...
        {
            h_Top_Chi3Dlog->Fill((*v_ST_tW_antitop_Chi3Dlog)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        }
        //----------------
        // Jet Pt, Jet Eta
        //----------------
        for (size_t i = 0; i < v_ST_tW_antitop_JetPT->size(); i++)
        {
            if ((*v_ST_tW_antitop_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_bjet->Fill((*v_ST_tW_antitop_JetPT)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
            }
            if ((*v_ST_tW_antitop_Jethadronflavor)[i] == 4 || (*v_ST_tW_antitop_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_heavy->Fill((*v_ST_tW_antitop_JetPT)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
            }
            else
            {
                h_Top_jetpt_heavy->Fill((*v_ST_tW_antitop_JetPT)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        ...
        for (size_t i = 0; i < v_ST_tW_antitop_JetEta->size(); i++)
        {
            if ((*v_ST_tW_antitop_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_bjet->Fill((*v_ST_tW_antitop_JetEta)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
            }

            if ((*v_ST_tW_antitop_Jethadronflavor)[i] == 4 || (*v_ST_tW_antitop_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_heavy->Fill((*v_ST_tW_antitop_JetEta)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
            }
            else
            {
                h_Top_jeteta_heavy->Fill((*v_ST_tW_antitop_JetEta)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        ...
        {
            h_Top_nTracks->Fill((*v_ST_tW_antitop_nTrack)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
            if ((*v_ST_tW_antitop_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_bjet->Fill((*v_ST_tW_antitop_nTrack)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
            }
            else
            {
                h_Top_nTracks_exclu_bjet->Fill((*v_ST_tW_antitop_nTrack)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
            }
            if ((*v_ST_tW_antitop_Jethadronflavor)[i] == 4 || (*v_ST_tW_antitop_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_heavy->Fill((*v_ST_tW_antitop_nTrack)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
            }
            else
            {
                h_Top_nTracks_light->Fill((*v_ST_tW_antitop_nTrack)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
            }
            if ((*v_ST_tW_antitop_alpha)[i] < 0.15)
            {
                h_Top_nTracks_cut->Fill((*v_ST_tW_antitop_nTrack)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
                if ((*v_ST_tW_antitop_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_bjet_cut->Fill((*v_ST_tW_antitop_nTrack)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
                }
                else
                {
                    h_Top_nTracks_exclu_bjet_cut->Fill((*v_ST_tW_antitop_nTrack)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
                }
                if ((*v_ST_tW_antitop_Jethadronflavor)[i] == 4 || (*v_ST_tW_antitop_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_heavy_cut->Fill((*v_ST_tW_antitop_nTrack)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
                }
                else
                {
                    h_Top_nTracks_light_cut->Fill((*v_ST_tW_antitop_nTrack)[i], I_ST_tW_antitop_weight * ST_tW_antitopWeight);
                }
            } // alpha cut
        }
    ...
    for (int evt = 0; evt < T_TTWJetsToLNu_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_alpha[0]->Fill((*v_TTWJetsToLNu_alpha)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        }
        for (size_t i = 0; i < v_TTWJetsToLNu_alpha2->size(); i++)
        {
            h_Top_alpha[1]->Fill((*v_TTWJetsToLNu_alpha2)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        }
        for (size_t i = 0; i < v_TTWJetsToLNu_alpha3->size(); i++)
        {
            h_Top_alpha[2]->Fill((*v_TTWJetsToLNu_alpha3)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        }
        for (size_t i = 0; i < v_TTWJetsToLNu_alpha4->size(); i++)
        {
            h_Top_alpha[3]->Fill((*v_TTWJetsToLNu_alpha4)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        }
        //----------
        //  3DSig
        //----------
        ...
        {
            h_Top_Chi3Dlog->Fill((*v_TTWJetsToLNu_Chi3Dlog)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        }
        //----------------
        // Jet Pt, Jet Eta
        //----------------
        for (size_t i = 0; i < v_TTWJetsToLNu_JetPT->size(); i++)
        {
            if ((*v_TTWJetsToLNu_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_bjet->Fill((*v_TTWJetsToLNu_JetPT)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
            }
            if ((*v_TTWJetsToLNu_Jethadronflavor)[i] == 4 || (*v_TTWJetsToLNu_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_heavy->Fill((*v_TTWJetsToLNu_JetPT)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
            }
            else
            {
                h_Top_jetpt_heavy->Fill((*v_TTWJetsToLNu_JetPT)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        ...
        for (size_t i = 0; i < v_TTWJetsToLNu_JetEta->size(); i++)
        {
            if ((*v_TTWJetsToLNu_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_bjet->Fill((*v_TTWJetsToLNu_JetEta)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
            }
            if ((*v_TTWJetsToLNu_Jethadronflavor)[i] == 4 || (*v_TTWJetsToLNu_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_heavy->Fill((*v_TTWJetsToLNu_JetEta)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
            }
            else
            {
                h_Top_jeteta_heavy->Fill((*v_TTWJetsToLNu_JetEta)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        ...
        {
            h_Top_nTracks->Fill((*v_TTWJetsToLNu_nTrack)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
            if ((*v_TTWJetsToLNu_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_bjet->Fill((*v_TTWJetsToLNu_nTrack)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
            }
            else
            {
                h_Top_nTracks_exclu_bjet->Fill((*v_TTWJetsToLNu_nTrack)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
            }
            if ((*v_TTWJetsToLNu_Jethadronflavor)[i] == 4 || (*v_TTWJetsToLNu_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_heavy->Fill((*v_TTWJetsToLNu_nTrack)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
            }
            else
            {
                h_Top_nTracks_light->Fill((*v_TTWJetsToLNu_nTrack)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
            }
            if ((*v_TTWJetsToLNu_alpha)[i] < 0.15)
            {
                h_Top_nTracks_cut->Fill((*v_TTWJetsToLNu_nTrack)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
                if ((*v_TTWJetsToLNu_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_bjet_cut->Fill((*v_TTWJetsToLNu_nTrack)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
                }
                else
                {
                    h_Top_nTracks_exclu_bjet_cut->Fill((*v_TTWJetsToLNu_nTrack)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
                }
                if ((*v_TTWJetsToLNu_Jethadronflavor)[i] == 4 || (*v_TTWJetsToLNu_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_heavy_cut->Fill((*v_TTWJetsToLNu_nTrack)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
                }
                else
                {
                    h_Top_nTracks_light_cut->Fill((*v_TTWJetsToLNu_nTrack)[i], I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
                }
            } // alpha cut
        }
    } // End of TTWJetsToLNu
    ...
    for (int evt = 0; evt < T_TTWJetsToQQ_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_alpha[0]->Fill((*v_TTWJetsToQQ_alpha)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        }
        for (size_t i = 0; i < v_TTWJetsToQQ_alpha2->size(); i++)
        {
            h_Top_alpha[1]->Fill((*v_TTWJetsToQQ_alpha2)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        }
        for (size_t i = 0; i < v_TTWJetsToQQ_alpha3->size(); i++)
        {
            h_Top_alpha[2]->Fill((*v_TTWJetsToQQ_alpha3)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        }
        for (size_t i = 0; i < v_TTWJetsToQQ_alpha4->size(); i++)
        {
            h_Top_alpha[3]->Fill((*v_TTWJetsToQQ_alpha4)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        }
        //----------
        //  3DSig
        //----------
        ...
        {
            h_Top_Chi3Dlog->Fill((*v_TTWJetsToQQ_Chi3Dlog)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        }
        //----------------
        // Jet Pt, Jet Eta
        //----------------
        for (size_t i = 0; i < v_TTWJetsToQQ_JetPT->size(); i++)
        {
            if ((*v_TTWJetsToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_bjet->Fill((*v_TTWJetsToQQ_JetPT)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
            }
            if ((*v_TTWJetsToQQ_Jethadronflavor)[i] == 4 || (*v_TTWJetsToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_heavy->Fill((*v_TTWJetsToQQ_JetPT)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
            }
            else
            {
                h_Top_jetpt_heavy->Fill((*v_TTWJetsToQQ_JetPT)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        ...
        for (size_t i = 0; i < v_TTWJetsToQQ_JetEta->size(); i++)
        {
            if ((*v_TTWJetsToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_bjet->Fill((*v_TTWJetsToQQ_JetEta)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
            }
            if ((*v_TTWJetsToQQ_Jethadronflavor)[i] == 4 || (*v_TTWJetsToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_heavy->Fill((*v_TTWJetsToQQ_JetEta)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
            }
            else
            {
                h_Top_jeteta_heavy->Fill((*v_TTWJetsToQQ_JetEta)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        ...
        {
            h_Top_nTracks->Fill((*v_TTWJetsToQQ_nTrack)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
            if ((*v_TTWJetsToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_bjet->Fill((*v_TTWJetsToQQ_nTrack)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
            }
            else
            {
                h_Top_nTracks_exclu_bjet->Fill((*v_TTWJetsToQQ_nTrack)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
            }
            if ((*v_TTWJetsToQQ_Jethadronflavor)[i] == 4 || (*v_TTWJetsToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_heavy->Fill((*v_TTWJetsToQQ_nTrack)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
            }
            else
            {
                h_Top_nTracks_light->Fill((*v_TTWJetsToQQ_nTrack)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
            }
            if ((*v_TTWJetsToQQ_alpha)[i] < 0.15)
            {
                h_Top_nTracks_cut->Fill((*v_TTWJetsToQQ_nTrack)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
                if ((*v_TTWJetsToQQ_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_bjet->Fill((*v_TTWJetsToQQ_nTrack)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
                }
                ...
                {
                    h_Top_nTracks_exclu_bjet_cut->Fill((*v_TTWJetsToQQ_nTrack)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
                }
                if ((*v_TTWJetsToQQ_Jethadronflavor)[i] == 4 || (*v_TTWJetsToQQ_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_heavy_cut->Fill((*v_TTWJetsToQQ_nTrack)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
                }
                else
                {
                    h_Top_nTracks_light_cut->Fill((*v_TTWJetsToQQ_nTrack)[i], I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
                }
            } // alpha cut
        }
    } // End of TTWJetsToQQ
    ...
    for (int evt = 0; evt < T_TTZToLLNuNu_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_alpha[0]->Fill((*v_TTZToLLNuNu_alpha)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
        }
        for (size_t i = 0; i < v_TTZToLLNuNu_alpha2->size(); i++)
        {
            h_Top_alpha[1]->Fill((*v_TTZToLLNuNu_alpha2)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
        }
        for (size_t i = 0; i < v_TTZToLLNuNu_alpha3->size(); i++)
        {
            h_Top_alpha[2]->Fill((*v_TTZToLLNuNu_alpha3)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
        }
        for (size_t i = 0; i < v_TTZToLLNuNu_alpha4->size(); i++)
        {
            h_Top_alpha[3]->Fill((*v_TTZToLLNuNu_alpha4)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
        }
        //----------
        //  3DSig
        //----------
        ...
        {
            h_Top_Chi3Dlog->Fill((*v_TTZToLLNuNu_Chi3Dlog)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
        }
        //----------------
        // Jet Pt, Jet Eta
        //----------------
        for (size_t i = 0; i < v_TTZToLLNuNu_JetPT->size(); i++)
        {
            if ((*v_TTZToLLNuNu_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_bjet->Fill((*v_TTZToLLNuNu_JetPT)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            }
            if ((*v_TTZToLLNuNu_Jethadronflavor)[i] == 4 || (*v_TTZToLLNuNu_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_heavy->Fill((*v_TTZToLLNuNu_JetPT)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            }
            else
            {
                h_Top_jetpt_light->Fill((*v_TTZToLLNuNu_JetPT)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            }
        }
        for (size_t i = 0; i < v_TTZToLLNuNu_JetEta->size(); i++)
        {
            if ((*v_TTZToLLNuNu_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_bjet->Fill((*v_TTZToLLNuNu_JetEta)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            }
            if ((*v_TTZToLLNuNu_Jethadronflavor)[i] == 4 || (*v_TTZToLLNuNu_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_heavy->Fill((*v_TTZToLLNuNu_JetEta)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            }
            else
            {
                h_Top_jeteta_light->Fill((*v_TTZToLLNuNu_JetEta)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            }
        }

        for (size_t i = 0; i < v_TTZToLLNuNu_nTrack->size(); i++)
        {
            h_Top_nTracks->Fill((*v_TTZToLLNuNu_nTrack)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            if ((*v_TTZToLLNuNu_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_bjet->Fill((*v_TTZToLLNuNu_nTrack)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            }
            else
            {
                h_Top_nTracks_exclu_bjet->Fill((*v_TTZToLLNuNu_nTrack)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            }
            if ((*v_TTZToLLNuNu_Jethadronflavor)[i] == 4 || (*v_TTZToLLNuNu_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_heavy->Fill((*v_TTZToLLNuNu_nTrack)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            }
            else
            {
                h_Top_nTracks_light->Fill((*v_TTZToLLNuNu_nTrack)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
            }
            if ((*v_TTZToLLNuNu_alpha)[i] < 0.15)
            {
                h_Top_nTracks_cut->Fill((*v_TTZToLLNuNu_nTrack)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
                if ((*v_TTZToLLNuNu_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_bjet_cut->Fill((*v_TTZToLLNuNu_nTrack)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
                }
                else
                {
                    h_Top_nTracks_exclu_bjet_cut->Fill((*v_TTZToLLNuNu_nTrack)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
                }
                if ((*v_TTZToLLNuNu_Jethadronflavor)[i] == 4 || (*v_TTZToLLNuNu_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_heavy_cut->Fill((*v_TTZToLLNuNu_nTrack)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
                }
                else
                {
                    h_Top_nTracks_light_cut->Fill((*v_TTZToLLNuNu_nTrack)[i], I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
                }
            } // alpha cut
        }
    } // End of TTZToLLNuNu
    ...
    for (int evt = 0; evt < T_TTZToQQ_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_alpha[0]->Fill((*v_TTZToQQ_alpha)[i], I_TTZToQQ_weight * TTZToQQWeight);
        }
        for (size_t i = 0; i < v_TTZToQQ_alpha2->size(); i++)
        {
            h_Top_alpha[1]->Fill((*v_TTZToQQ_alpha2)[i], I_TTZToQQ_weight * TTZToQQWeight);
        }
        for (size_t i = 0; i < v_TTZToQQ_alpha3->size(); i++)
        {
            h_Top_alpha[2]->Fill((*v_TTZToQQ_alpha3)[i], I_TTZToQQ_weight * TTZToQQWeight);
        }
        for (size_t i = 0; i < v_TTZToQQ_alpha4->size(); i++)
        {
            h_Top_alpha[3]->Fill((*v_TTZToQQ_alpha4)[i], I_TTZToQQ_weight * TTZToQQWeight);
        }
        //----------
        //  3DSig
        //----------
        ...
        {
            h_Top_Chi3Dlog->Fill((*v_TTZToQQ_Chi3Dlog)[i], I_TTZToQQ_weight * TTZToQQWeight);
        }
        //----------------
        // Jet Pt, Jet Eta
        //----------------
        for (size_t i = 0; i < v_TTZToQQ_JetPT->size(); i++)
        {
            if ((*v_TTZToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_bjet->Fill((*v_TTZToQQ_JetPT)[i], I_TTZToQQ_weight * TTZToQQWeight);
            }
            if ((*v_TTZToQQ_Jethadronflavor)[i] == 4 || (*v_TTZToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_jetpt_heavy->Fill((*v_TTZToQQ_JetPT)[i], I_TTZToQQ_weight * TTZToQQWeight);
            }
            else
            {
                h_Top_jetpt_light->Fill((*v_TTZToQQ_JetPT)[i], I_TTZToQQ_weight * TTZToQQWeight);
            }
        }
        for (size_t i = 0; i < v_TTZToQQ_JetEta->size(); i++)
        {
            if ((*v_TTZToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_bjet->Fill((*v_TTZToQQ_JetEta)[i], I_TTZToQQ_weight * TTZToQQWeight);
            }
            if ((*v_TTZToQQ_Jethadronflavor)[i] == 4 || (*v_TTZToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_jeteta_heavy->Fill((*v_TTZToQQ_JetEta)[i], I_TTZToQQ_weight * TTZToQQWeight);
            }
            else
            {
                h_Top_jeteta_light->Fill((*v_TTZToQQ_JetEta)[i], I_TTZToQQ_weight * TTZToQQWeight);
            }
        }
        for (size_t i = 0; i < v_TTZToQQ_nTrack->size(); i++)
        {
            h_Top_nTracks->Fill((*v_TTZToQQ_nTrack)[i], I_TTZToQQ_weight * TTZToQQWeight);
            if ((*v_TTZToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_bjet->Fill((*v_TTZToQQ_nTrack)[i], I_TTZToQQ_weight * TTZToQQWeight);
            }
            else
            {
                h_Top_nTracks_exclu_bjet->Fill((*v_TTZToQQ_nTrack)[i], I_TTZToQQ_weight * TTZToQQWeight);
            }
            if ((*v_TTZToQQ_Jethadronflavor)[i] == 4 || (*v_TTZToQQ_Jethadronflavor)[i] == 5)
            {
                h_Top_nTracks_heavy->Fill((*v_TTZToQQ_nTrack)[i], I_TTZToQQ_weight * TTZToQQWeight);
            }
            else
            {
                h_Top_nTracks_light->Fill((*v_TTZToQQ_nTrack)[i], I_TTZToQQ_weight * TTZToQQWeight);
            }
            if ((*v_TTZToQQ_alpha)[i] < 0.15)
            {
                h_Top_nTracks_cut->Fill((*v_TTZToQQ_nTrack)[i], I_TTZToQQ_weight * TTZToQQWeight);
                if ((*v_TTZToQQ_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_bjet_cut->Fill((*v_TTZToQQ_nTrack)[i], I_TTZToQQ_weight * TTZToQQWeight);
                }
                else
                {
                    h_Top_nTracks_exclu_bjet_cut->Fill((*v_TTZToQQ_nTrack)[i], I_TTZToQQ_weight * TTZToQQWeight);
                }
                if ((*v_TTZToQQ_Jethadronflavor)[i] == 4 || (*v_TTZToQQ_Jethadronflavor)[i] == 5)
                {
                    h_Top_nTracks_heavy_cut->Fill((*v_TTZToQQ_nTrack)[i], I_TTZToQQ_weight * TTZToQQWeight);
                }
                else
                {
                    h_Top_nTracks_light_cut->Fill((*v_TTZToQQ_nTrack)[i], I_TTZToQQ_weight * TTZToQQWeight);
                }
            } // alpha cut
        }
    } // End of TTZToQQ

    h_Top_Met->SetLineWidth(2);
    h_Top_Met->Draw();
    ...
    TH1F *Top_exclu_bjet_fakeRate = (TH1F *)h_Top_nTracks_exclu_bjet_cut->Clone("Top_exclu_bjet_fakeRate");
    Top_exclu_bjet_fakeRate->Divide(h_Top_nTracks_exclu_bjet_cut, h_Top_nTracks_exclu_bjet, 1, 1, "b");

    Top_exclu_bjet_fakeRate->SetLineWidth(2);
    Top_exclu_bjet_fakeRate->Draw("");
...
int main(int argc, char *argv[])
{
    ...
    {
        ee_Top_produce_v2(argv[1], argv[2]);
    }
    else
    {
        cout << "argc" << argc << endl;
