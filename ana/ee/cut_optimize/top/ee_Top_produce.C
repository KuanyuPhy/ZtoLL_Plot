...
void ee_Top_produce(TString inputfile = "./../../../../../../root_file/Ztoee/2016BKGMC/top/top_TTTo2L2Nu.root", TString outputfile1 = "./ee_Top_emjet.root")
{
    ...
    for (int evt = 0; evt < T_TTTo2L2Nu_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_IP2D->Fill(log10(abs((*v_TTTo2L2Nu_2DIP)[i])), TTTo2L2Nu_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_ST_tW_top_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_IP2D->Fill(log10(abs((*v_ST_tW_top_2DIP)[i])), ST_tW_top_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_ST_tW_antitop_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_IP2D->Fill(log10(abs((*v_ST_tW_antitop_2DIP)[i])), ST_tW_antitop_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_TTWJetsToLNu_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_IP2D->Fill(log10(abs((*v_TTWJetsToLNu_2DIP)[i])), TTWJetsToLNu_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_TTWJetsToQQ_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_IP2D->Fill(log10(abs((*v_TTWJetsToQQ_2DIP)[i])), TTWJetsToQQ_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_TTZToQQ_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_IP2D->Fill(log10(abs((*v_TTZToQQ_2DIP)[i])), TTZToQQ_eventWeight);
        }
    ...
    for (int evt = 0; evt < T_TTZToLLNuNu_tree->GetEntries(); evt++)
    {
        ...
        {
            h_Top_IP2D->Fill(log10(abs((*v_TTZToLLNuNu_2DIP)[i])), TTZToLLNuNu_eventWeight);
        }
