...
void quick_2D_flavor_met()
{
    ...
    TH1D *h_MX1_Chi3DPaperlog = new TH1D("h_MX1_Chi3DPaperlog", "", 100, -10, 10);
    h_MX1_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_MX1_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_MX1_Chi3DPaperlog->Sumw2();

    TH2F *h_ht0_leadJetFlavor_Met = new TH2F("h_ht0_leadJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht70_leadJetFlavor_Met = new TH2F("h_ht70_leadJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht100_leadJetFlavor_Met = new TH2F("h_ht100_leadJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht200_leadJetFlavor_Met = new TH2F("h_ht200_leadJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht400_leadJetFlavor_Met = new TH2F("h_ht400_leadJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht600_leadJetFlavor_Met = new TH2F("h_ht600_leadJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht800_leadJetFlavor_Met = new TH2F("h_ht800_leadJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht1200_leadJetFlavor_Met = new TH2F("h_ht1200_leadJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht2500_leadJetFlavor_Met = new TH2F("h_ht2500_leadJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);

    TH2F *h_ht0_minalphaJetFlavor_Met = new TH2F("h_ht0_minalphaJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht70_minalphaJetFlavor_Met = new TH2F("h_ht70_minalphaJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht100_minalphaJetFlavor_Met = new TH2F("h_ht100_minalphaJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht200_minalphaJetFlavor_Met = new TH2F("h_ht200_minalphaJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht400_minalphaJetFlavor_Met = new TH2F("h_ht400_minalphaJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht600_minalphaJetFlavor_Met = new TH2F("h_ht600_minalphaJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht800_minalphaJetFlavor_Met = new TH2F("h_ht800_minalphaJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht1200_minalphaJetFlavor_Met = new TH2F("h_ht1200_minalphaJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    TH2F *h_ht2500_minalphaJetFlavor_Met = new TH2F("h_ht2500_minalphaJetFlavor_Met", "", 6, 0, 6, 20, 0, 800);
    ...
    for (int evt = 0; evt < T_event->GetEntries(); evt++)
    {
        ...
        if (I_ht0_nThinJets < 2)
            continue;
        if (f_ht0_alphamin > somelowvalue && f_ht0_alphamin < someupvalue)
            continue;
        if (HT < 70)
        {
            h_ht0_leadJetFlavor_Met->Fill(I_ht0_leadJetflavor, f_ht0_Met, I_ht0_weight * HT0Weight);
            h_ht0_minalphaJetFlavor_Met->Fill(I_ht0_minJetflavor, f_ht0_Met, I_ht0_weight * HT0Weight);
        }
        else if (HT >= 70 && HT < 100)
        {
            h_ht70_leadJetFlavor_Met->Fill(I_ht0_leadJetflavor, f_ht0_Met, I_ht0_weight * HT70Weight);
            h_ht70_minalphaJetFlavor_Met->Fill(I_ht0_minJetflavor, f_ht0_Met, I_ht0_weight * HT70Weight);
        }
        else if (HT >= 100 && HT < 200)
        {
            h_ht100_leadJetFlavor_Met->Fill(I_ht0_leadJetflavor, f_ht0_Met, I_ht0_weight * HT100Weight);
            h_ht100_minalphaJetFlavor_Met->Fill(I_ht0_minJetflavor, f_ht0_Met, I_ht0_weight * HT100Weight);
        }

        else if (HT >= 200 && HT < 400)
        {
            h_ht200_leadJetFlavor_Met->Fill(I_ht0_leadJetflavor, f_ht0_Met, I_ht0_weight * HT200Weight);
            h_ht200_minalphaJetFlavor_Met->Fill(I_ht0_minJetflavor, f_ht0_Met, I_ht0_weight * HT200Weight);
        }
        else if (HT >= 400 && HT < 600)
        {
            h_ht400_leadJetFlavor_Met->Fill(I_ht0_leadJetflavor, f_ht0_Met, I_ht0_weight * HT400Weight);
            h_ht400_minalphaJetFlavor_Met->Fill(I_ht0_minJetflavor, f_ht0_Met, I_ht0_weight * HT400Weight);
        }
        else if (HT >= 600 && HT < 800)
        {
            h_ht600_leadJetFlavor_Met->Fill(I_ht0_leadJetflavor, f_ht0_Met, I_ht0_weight * HT600Weight);
            h_ht600_minalphaJetFlavor_Met->Fill(I_ht0_minJetflavor, f_ht0_Met, I_ht0_weight * HT600Weight);
        }
        else if (HT >= 800 && HT < 1200)
        {
            h_ht800_leadJetFlavor_Met->Fill(I_ht0_leadJetflavor, f_ht0_Met, I_ht0_weight * HT800Weight);
            h_ht800_minalphaJetFlavor_Met->Fill(I_ht0_minJetflavor, f_ht0_Met, I_ht0_weight * HT800Weight);
        }
        else if (HT >= 1200 && HT < 2500)
        {
            h_ht1200_leadJetFlavor_Met->Fill(I_ht0_leadJetflavor, f_ht0_Met, I_ht0_weight * HT1200Weight);
            h_ht1200_minalphaJetFlavor_Met->Fill(I_ht0_minJetflavor, f_ht0_Met, I_ht0_weight * HT1200Weight);
        }
        else if (HT >= 2500)
        {
            h_ht2500_leadJetFlavor_Met->Fill(I_ht0_leadJetflavor, f_ht0_Met, I_ht0_weight * HT2500Weight);
            h_ht2500_minalphaJetFlavor_Met->Fill(I_ht0_minJetflavor, f_ht0_Met, I_ht0_weight * HT2500Weight);
        }
    }
    TTree *T_event1;
    ...
    for (int evt = 0; evt < T_event1->GetEntries(); evt++)
    {
        ...
        if (I_ht100_nThinJets < 2)
            continue;
        if (f_ht100_alphamin > somelowvalue && f_ht100_alphamin < someupvalue)
            continue;
        h_ht100_leadJetFlavor_Met->Fill(I_ht100_leadJetflavor, f_ht100_Met, I_ht100_weight * HT100Weight);
        h_ht100_minalphaJetFlavor_Met->Fill(I_ht100_minJetflavor, f_ht100_Met, I_ht100_weight * HT100Weight);
    }
    TTree *T_event2;
    ...
    for (int evt = 0; evt < T_event2->GetEntries(); evt++)
    {
        ...
        if (I_ht200_nThinJets < 2)
            continue;
        if (f_ht200_alphamin > somelowvalue)
            continue;
        h_ht200_leadJetFlavor_Met->Fill(I_ht200_leadJetflavor, f_ht200_Met, I_ht200_weight * I_ht200_weight);
        h_ht200_minalphaJetFlavor_Met->Fill(I_ht200_minJetflavor, f_ht200_Met, I_ht200_weight * HT200Weight);
    }
    TTree *T_event3;
    ...
    for (int evt = 0; evt < T_event3->GetEntries(); evt++)
    {
        ...
        if (I_ht400_nThinJets < 2)
            continue;
        if (f_ht400_alphamin > somelowvalue && f_ht400_alphamin < someupvalue)
            continue;
        h_ht400_leadJetFlavor_Met->Fill(I_ht400_leadJetflavor, f_ht400_Met, I_ht400_weight * HT400Weight);
        h_ht400_minalphaJetFlavor_Met->Fill(I_ht400_minJetflavor, f_ht400_Met, I_ht400_weight * HT400Weight);
    }
    TTree *T_event4;
    ...
    for (int evt = 0; evt < T_event4->GetEntries(); evt++)
    {
        ...
        if (I_ht600_nThinJets < 2)
            continue;
        if (f_ht600_alphamin > somelowvalue && f_ht600_alphamin < someupvalue)
            continue;
        h_ht600_leadJetFlavor_Met->Fill(I_ht600_leadJetflavor, f_ht600_Met, I_ht600_weight * HT600Weight);
        h_ht600_minalphaJetFlavor_Met->Fill(I_ht600_minJetflavor, f_ht600_Met, I_ht600_weight * HT600Weight);
    }
    TTree *T_event5;
    ...
    for (int evt = 0; evt < T_event5->GetEntries(); evt++)
    {
        ...
        if (I_ht800_nThinJets < 2)
            continue;
        if (f_ht800_alphamin > somelowvalue && f_ht800_alphamin < someupvalue)
            continue;
        h_ht800_leadJetFlavor_Met->Fill(I_ht800_leadJetflavor, f_ht800_Met, I_ht800_weight * HT800Weight);
        h_ht800_minalphaJetFlavor_Met->Fill(I_ht800_minJetflavor, f_ht800_Met, I_ht800_weight * HT800Weight);
    }
    TTree *T_event6;
    ...
    for (int evt = 0; evt < T_event6->GetEntries(); evt++)
    {
        ...
        if (I_ht1200_nThinJets < 2)
            continue;
        if (f_ht1200_alphamin > somelowvalue && f_ht1200_alphamin < someupvalue)
            continue;
        h_ht1200_leadJetFlavor_Met->Fill(I_ht1200_leadJetflavor, f_ht1200_Met, I_ht1200_weight * HT1200Weight);
        h_ht1200_minalphaJetFlavor_Met->Fill(I_ht1200_minJetflavor, f_ht1200_Met, I_ht1200_weight * HT1200Weight);
    }
    ...
    for (int evt = 0; evt < T_event7->GetEntries(); evt++)
    {
        ...
        if (I_ht2500_nThinJets < 2)
            continue;
        if (f_ht2500_alphamin > somelowvalue && f_ht2500_alphamin < someupvalue)
            continue;
        h_ht2500_leadJetFlavor_Met->Fill(I_ht2500_leadJetflavor, f_ht2500_Met, I_ht2500_weight * HT2500Weight);
        h_ht2500_minalphaJetFlavor_Met->Fill(I_ht2500_minJetflavor, f_ht2500_Met, I_ht2500_weight * HT2500Weight);
    }
    h_ht0_leadJetFlavor_Met->Add(h_ht70_leadJetFlavor_Met);
    h_ht0_leadJetFlavor_Met->Add(h_ht100_leadJetFlavor_Met);
    h_ht0_leadJetFlavor_Met->Add(h_ht200_leadJetFlavor_Met);
    h_ht0_leadJetFlavor_Met->Add(h_ht400_leadJetFlavor_Met);
    h_ht0_leadJetFlavor_Met->Add(h_ht600_leadJetFlavor_Met);
    h_ht0_leadJetFlavor_Met->Add(h_ht800_leadJetFlavor_Met);
    h_ht0_leadJetFlavor_Met->Add(h_ht1200_leadJetFlavor_Met);
    h_ht0_leadJetFlavor_Met->Add(h_ht2500_leadJetFlavor_Met);
    h_ht0_minalphaJetFlavor_Met->Add(h_ht70_minalphaJetFlavor_Met);
    h_ht0_minalphaJetFlavor_Met->Add(h_ht100_minalphaJetFlavor_Met);
    h_ht0_minalphaJetFlavor_Met->Add(h_ht200_minalphaJetFlavor_Met);
    h_ht0_minalphaJetFlavor_Met->Add(h_ht400_minalphaJetFlavor_Met);
    h_ht0_minalphaJetFlavor_Met->Add(h_ht600_minalphaJetFlavor_Met);
    h_ht0_minalphaJetFlavor_Met->Add(h_ht800_minalphaJetFlavor_Met);
    h_ht0_minalphaJetFlavor_Met->Add(h_ht1200_minalphaJetFlavor_Met);
    h_ht0_minalphaJetFlavor_Met->Add(h_ht2500_minalphaJetFlavor_Met);
    ...
    Mx1_tree->SetBranchAddress("I_leadJetflavor", &I_Mx1_leadJetflavor);
    Mx1_tree->SetBranchAddress("I_minJetflavor", &I_Mx150_minJetflavor);
    ...
    Mx50_tree->SetBranchAddress("I_leadJetflavor", &I_Mx50_leadJetflavor);
    Mx50_tree->SetBranchAddress("I_minJetflavor", &I_Mx150_minJetflavor);
    ...
    Mx150_tree->SetBranchAddress("I_leadJetflavor", &I_Mx150_leadJetflavor);
    Mx150_tree->SetBranchAddress("I_minJetflavor", &I_Mx150_minJetflavor);
    ...
    */
    ...
    c2->Divide(2, 1);
    c2->cd(1);
    h_ht0_leadJetFlavor_Met->SetTitle("leadJetflavor:Met");
    h_ht0_leadJetFlavor_Met->GetYaxis()->SetTitle("Met");
    h_ht0_leadJetFlavor_Met->GetXaxis()->SetTitle("leadJetflavor");
    h_ht0_leadJetFlavor_Met->Draw("Colz&&text45");
    c2->cd(2);
    h_ht0_minalphaJetFlavor_Met->SetTitle("leadJetflavor:Met");
    h_ht0_minalphaJetFlavor_Met->GetYaxis()->SetTitle("Met");
    h_ht0_minalphaJetFlavor_Met->GetXaxis()->SetTitle("minalphaJetflavor");
    h_ht0_minalphaJetFlavor_Met->Draw("Colz&&text45");
}