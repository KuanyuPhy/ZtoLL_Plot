...
void quick_deltaphi()
{
    ...
    float_t f_Mx1_deltaphi, f_Mx50_deltaphi, f_Mx150_deltaphi;
    Double_t d_Mx1_alphamin, d_Mx50_alphamin, d_Mx150_alphamin;

    vector<float_t> *v_Mx1_fakealpha = new vector<float>();
    vector<float_t> *v_Mx1_fakealpha = new vector<float>();
    vector<float_t> *v_Mx1_fakealpha = new vector<float>();
    ...
    Mx1_tree->SetBranchAddress("f_alphamin", &v_MetdeltaPhi);
