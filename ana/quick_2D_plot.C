...
void quick_2D_plot()
{
    ...
    TH2F *h_ht0_Met_multiplicity = new TH2F("h_ht0_Met_multiplicity", "", 20, 0, 800, 8, 0, 8);
    TH2F *h_ht70_Met_multiplicity = new TH2F("h_ht70_Met_multiplicity", "", 20, 0, 800, 8, 0, 8);
    TH2F *h_ht100_Met_multiplicity = new TH2F("h_ht100_Met_multiplicity", "", 20, 0, 800, 8, 0, 8);
    TH2F *h_ht200_Met_multiplicity = new TH2F("h_ht200_Met_multiplicity", "", 20, 0, 800, 8, 0, 8);
    TH2F *h_ht400_Met_multiplicity = new TH2F("h_ht400_Met_multiplicity", "", 20, 0, 800, 8, 0, 8);
    TH2F *h_ht600_Met_multiplicity = new TH2F("h_ht600_Met_multiplicity", "", 20, 0, 800, 8, 0, 8);
    TH2F *h_ht800_Met_multiplicity = new TH2F("h_ht800_Met_multiplicity", "", 20, 0, 800, 8, 0, 8);
    TH2F *h_ht1200_Met_multiplicity = new TH2F("h_ht1200_Met_multiplicity", "", 20, 0, 800, 8, 0, 8);
    TH2F *h_ht2500_Met_multiplicity = new TH2F("h_ht2500_Met_multiplicity", "", 20, 0, 800, 8, 0, 8);

    TH2F *h_ht0_Met_minJetPt = new TH2F("h_ht0_Met_minJetPt", "", 20, 0, 800, 100, 0, 1000);
    TH2F *h_ht70_Met_minJetPt = new TH2F("h_ht70_Met_minJetPt", "", 20, 0, 800, 100, 0, 1000);
    TH2F *h_ht100_Met_minJetPt = new TH2F("h_ht100_Met_minJetPt", "", 20, 0, 800, 100, 0, 1000);
    TH2F *h_ht200_Met_minJetPt = new TH2F("h_ht200_Met_minJetPt", "", 20, 0, 800, 100, 0, 1000);
    TH2F *h_ht400_Met_minJetPt = new TH2F("h_ht400_Met_minJetPt", "", 20, 0, 800, 100, 0, 1000);
    TH2F *h_ht600_Met_minJetPt = new TH2F("h_ht600_Met_minJetPt", "", 20, 0, 800, 100, 0, 1000);
    TH2F *h_ht800_Met_minJetPt = new TH2F("h_ht800_Met_minJetPt", "", 20, 0, 800, 100, 0, 1000);
    TH2F *h_ht1200_Met_minJetPt = new TH2F("h_ht1200_Met_minJetPt", "", 20, 0, 800, 100, 0, 1000);
    TH2F *h_ht2500_Met_minJetPt = new TH2F("h_ht2500_Met_minJetPt", "", 20, 0, 800, 100, 0, 1000);
    ...
    for (int evt = 0; evt < T_event->GetEntries(); evt++)
    {
        ...
        if (I_ht0_minJetflavor == 4 || I_ht0_minJetflavor == 5)
        {
            if (HT < 70)
            {
                ...
                h_ht0_Met_multiplicity->Fill(f_ht0_Met, I_ht0_disJet_multiplicity, I_ht0_weight * HT0Weight);
                h_ht0_Met_minJetPt->Fill(f_ht0_Met, f_ht0_minJetpt, I_ht0_weight * HT0Weight);
            }
            else if (HT >= 70 && HT < 100)
            {
                h_ht70_Met_alphamin->Fill(f_ht0_Met, f_ht0_alphamin, I_ht0_weight * HT70Weight);
                h_ht70_Met_multiplicity->Fill(f_ht0_Met, I_ht0_disJet_multiplicity, I_ht0_weight * HT70Weight);
                h_ht70_Met_minJetPt->Fill(f_ht0_Met, f_ht0_minJetpt, I_ht0_weight * HT70Weight);
            }
            else if (HT >= 100 && HT < 200)
            {
                h_ht100_Met_alphamin->Fill(f_ht0_Met, f_ht0_alphamin, I_ht0_weight * HT100Weight);
                h_ht100_Met_multiplicity->Fill(f_ht0_Met, I_ht0_disJet_multiplicity, I_ht0_weight * HT100Weight);
                h_ht100_Met_minJetPt->Fill(f_ht0_Met, f_ht0_minJetpt, I_ht0_weight * HT100Weight);
            }

            else if (HT >= 200 && HT < 400)
            {
                h_ht200_Met_alphamin->Fill(f_ht0_Met, f_ht0_alphamin, I_ht0_weight * HT200Weight);
                h_ht200_Met_multiplicity->Fill(f_ht0_Met, I_ht0_disJet_multiplicity, I_ht0_weight * HT200Weight);
                h_ht200_Met_minJetPt->Fill(f_ht0_Met, f_ht0_minJetpt, I_ht0_weight * HT200Weight);
            }
            else if (HT >= 400 && HT < 600)
            {
                h_ht400_Met_alphamin->Fill(f_ht0_Met, f_ht0_alphamin, I_ht0_weight * HT400Weight);
                h_ht400_Met_multiplicity->Fill(f_ht0_Met, I_ht0_disJet_multiplicity, I_ht0_weight * HT400Weight);
                h_ht400_Met_minJetPt->Fill(f_ht0_Met, f_ht0_minJetpt, I_ht0_weight * HT400Weight);
            }
            else if (HT >= 600 && HT < 800)
            {
                h_ht600_Met_alphamin->Fill(f_ht0_Met, f_ht0_alphamin, I_ht0_weight * HT600Weight);
                h_ht600_Met_multiplicity->Fill(f_ht0_Met, I_ht0_disJet_multiplicity, I_ht0_weight * HT600Weight);
                h_ht600_Met_minJetPt->Fill(f_ht0_Met, f_ht0_minJetpt, I_ht0_weight * HT600Weight);
            }
            else if (HT >= 800 && HT < 1200)
            {
                h_ht800_Met_alphamin->Fill(f_ht0_Met, f_ht0_alphamin, I_ht0_weight * HT800Weight);
                h_ht800_Met_multiplicity->Fill(f_ht0_Met, I_ht0_disJet_multiplicity, I_ht0_weight * HT800Weight);
                h_ht800_Met_minJetPt->Fill(f_ht0_Met, f_ht0_minJetpt, I_ht0_weight * HT800Weight);
            }
            else if (HT >= 1200 && HT < 2500)
            {
                h_ht1200_Met_alphamin->Fill(f_ht0_Met, f_ht0_alphamin, I_ht0_weight * HT1200Weight);
                h_ht1200_Met_multiplicity->Fill(f_ht0_Met, I_ht0_disJet_multiplicity, I_ht0_weight * HT1200Weight);
                h_ht1200_Met_minJetPt->Fill(f_ht0_Met, f_ht0_minJetpt, I_ht0_weight * HT1200Weight);
            }
            else if (HT >= 2500)
            {
                h_ht2500_Met_alphamin->Fill(f_ht0_Met, f_ht0_alphamin, I_ht0_weight * HT2500Weight);
                h_ht2500_Met_multiplicity->Fill(f_ht0_Met, I_ht0_disJet_multiplicity, I_ht0_weight * HT2500Weight);
                h_ht2500_Met_minJetPt->Fill(f_ht0_Met, f_ht0_minJetpt, I_ht0_weight * HT2500Weight);
            }
        }
    }
    TTree *T_event1;
    ...
    for (int evt = 0; evt < T_event1->GetEntries(); evt++)
    {
        ...
        if (I_ht100_minJetflavor == 4 || I_ht100_minJetflavor == 5)
        {
            ...
            h_ht100_Met_multiplicity->Fill(f_ht100_Met, I_ht100_disJet_multiplicity, I_ht100_weight * HT100Weight);
            h_ht100_Met_minJetPt->Fill(f_ht100_Met, f_ht100_minJetpt, I_ht100_weight * HT100Weight);
        }
    }
    TTree *T_event2;
    ...
    for (int evt = 0; evt < T_event2->GetEntries(); evt++)
    {
        ...
        {
            h_ht200_Met_alphamin->Fill(f_ht200_Met, f_ht200_alphamin, I_ht200_weight * HT200Weight);
            h_ht200_Met_multiplicity->Fill(f_ht200_Met, I_ht200_disJet_multiplicity, I_ht200_weight * HT200Weight);
            h_ht200_Met_minJetPt->Fill(f_ht200_Met, f_ht200_minJetpt, I_ht200_weight * HT200Weight);
        }
    }
    TTree *T_event3;
    ...
    for (int evt = 0; evt < T_event3->GetEntries(); evt++)
    {
        ...
        if (I_ht400_minJetflavor == 4 || I_ht400_minJetflavor == 5)
        {
            ...
            h_ht400_Met_multiplicity->Fill(f_ht400_Met, I_ht400_disJet_multiplicity, I_ht400_weight * HT400Weight);
            h_ht400_Met_minJetPt->Fill(f_ht400_Met, f_ht400_minJetpt, I_ht400_weight * HT400Weight);
        }
    }
    TTree *T_event4;
    ...
    for (int evt = 0; evt < T_event4->GetEntries(); evt++)
    {
        ...
        if (I_ht600_minJetflavor == 4 || I_ht600_minJetflavor == 5)
        {
            ...
            h_ht600_Met_multiplicity->Fill(f_ht600_Met, I_ht600_disJet_multiplicity, I_ht600_weight * HT600Weight);
            h_ht600_Met_minJetPt->Fill(f_ht600_Met, f_ht600_minJetpt, I_ht600_weight * HT600Weight);
        }
    }
    TTree *T_event5;
    ...
    for (int evt = 0; evt < T_event5->GetEntries(); evt++)
    {
        ...
        if (I_ht800_minJetflavor == 4 || I_ht800_minJetflavor == 5)
        {
            ...
            h_ht800_Met_multiplicity->Fill(f_ht800_Met, I_ht800_disJet_multiplicity, I_ht800_weight * HT800Weight);
            h_ht800_Met_minJetPt->Fill(f_ht800_Met, f_ht800_minJetpt, I_ht800_weight * HT800Weight);
        }
    }
    TTree *T_event6;
    ...
    for (int evt = 0; evt < T_event6->GetEntries(); evt++)
    {
        ...
        if (I_ht1200_minJetflavor == 4 || I_ht1200_minJetflavor == 5)
        {
            ...
            h_ht1200_Met_multiplicity->Fill(f_ht1200_Met, I_ht1200_disJet_multiplicity, I_ht1200_weight * HT1200Weight);
            h_ht1200_Met_minJetPt->Fill(f_ht1200_Met, f_ht1200_minJetpt, I_ht1200_weight * HT1200Weight);
        }
    }
    ...
    for (int evt = 0; evt < T_event7->GetEntries(); evt++)
    {
        ...
        if (I_ht2500_minJetflavor == 4 || I_ht2500_minJetflavor == 5)
        {
            ...
            h_ht2500_Met_multiplicity->Fill(f_ht2500_Met, I_ht2500_disJet_multiplicity, I_ht2500_weight * HT2500Weight);
            h_ht2500_Met_minJetPt->Fill(f_ht2500_Met, f_ht2500_minJetpt, I_ht2500_weight * HT2500Weight);
        }
    }
    ...
    h_ht0_Met_multiplicity->Add(h_ht70_Met_multiplicity);
    h_ht0_Met_multiplicity->Add(h_ht100_Met_multiplicity);
    h_ht0_Met_multiplicity->Add(h_ht200_Met_multiplicity);
    h_ht0_Met_multiplicity->Add(h_ht400_Met_multiplicity);
    h_ht0_Met_multiplicity->Add(h_ht600_Met_multiplicity);
    h_ht0_Met_multiplicity->Add(h_ht800_Met_multiplicity);
    h_ht0_Met_multiplicity->Add(h_ht1200_Met_multiplicity);
    h_ht0_Met_multiplicity->Add(h_ht2500_Met_multiplicity);

    h_ht0_Met_minJetPt->Add(h_ht70_Met_minJetPt);
    h_ht0_Met_minJetPt->Add(h_ht100_Met_minJetPt);
    h_ht0_Met_minJetPt->Add(h_ht200_Met_minJetPt);
    h_ht0_Met_minJetPt->Add(h_ht400_Met_minJetPt);
    h_ht0_Met_minJetPt->Add(h_ht600_Met_minJetPt);
    h_ht0_Met_minJetPt->Add(h_ht800_Met_minJetPt);
    h_ht0_Met_minJetPt->Add(h_ht1200_Met_minJetPt);
    h_ht0_Met_minJetPt->Add(h_ht2500_Met_minJetPt);
    ...
    h_ht0_Met_multiplicity->SetTitle("Met :Jet multiplicity");
    h_ht0_Met_multiplicity->GetXaxis()->SetTitle("");

    h_ht0_Met_minJetPt->SetTitle("Met :minJet Pt");
    h_ht0_Met_minJetPt->Draw("Colz1");
}