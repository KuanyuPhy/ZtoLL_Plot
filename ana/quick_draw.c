...
void quick_draw()
{
    ...
    TFile *Mx2_1 = new TFile("./../../root_file/test1nb.root");
    TFile *Mx2_50 = new TFile("./../../root_file/test50nb.root");
    TFile *Mx2_150 = new TFile("./../../root_file/test150nb.root");
    ...
    TFile *DYpT50 = new TFile("./../../root_file/tmppt50_100.root");
    TFile *DYpT100 = new TFile("./../../root_file/tmppt100_250.root");
    TFile *DYpT250 = new TFile("./../../root_file/tmppt250_400.root");
    TFile *DYpT400 = new TFile("./../../root_file/tmppt400_650.root");
    TFile *DYpT650 = new TFile("./../../root_file/tmppt650_Inf.root");

    TH1D *Mx2_1_nT = ((TH1D *)Mx2_1->Get("PUdz"));
    TH1D *Mx2_50_nT = ((TH1D *)Mx2_50->Get("PUdz"));
    TH1D *Mx2_150_nT = ((TH1D *)Mx2_150->Get("PUdz"));

    /*
    TH1D *HT_CS = ((TH1D *)DYHT70->Get("h_HTCS"));
    TH1D *HT70_nT = ((TH1D *)DYHT70->Get("PUdz"));
    TH1D *HT70_evt = ((TH1D *)DYHT70->Get("h_event"));

    TH1D *HT100_nT = ((TH1D *)DYHT100->Get("PUdz"));
    TH1D *HT100_evt = ((TH1D *)DYHT100->Get("h_event"));

    TH1D *HT200_nT = ((TH1D *)DYHT200->Get("PUdz"));
    TH1D *HT200_evt = ((TH1D *)DYHT200->Get("h_event"));
    TH1D *HT400_nT = ((TH1D *)DYHT400->Get("PUdz"));
    TH1D *HT400_evt = ((TH1D *)DYHT400->Get("h_event"));
    TH1D *HT600_nT = ((TH1D *)DYHT600->Get("PUdz"));
    TH1D *HT600_evt = ((TH1D *)DYHT600->Get("h_event"));
    TH1D *HT800_nT = ((TH1D *)DYHT800->Get("PUdz"));
    TH1D *HT800_evt = ((TH1D *)DYHT800->Get("h_event"));
    TH1D *HT1200_nT = ((TH1D *)DYHT1200->Get("PUdz"));
    TH1D *HT1200_evt = ((TH1D *)DYHT1200->Get("h_event"));
    TH1D *HT2500_nT = ((TH1D *)DYHT2500->Get("PUdz"));
    TH1D *HT2500_evt = ((TH1D *)DYHT2500->Get("h_event"));
    */
    //TH1D *h_PTCS = ((TH1D *)DYpT50->Get("h_PTCS"));
    TH1D *DYPT50_nT = ((TH1D *)DYpT50->Get("PUdz"));
    TH1D *DYPT50_sumW = ((TH1D *)DYpT50->Get("h_SumWeight"));
    TH1D *DYPT100_nT = ((TH1D *)DYpT100->Get("PUdz"));
    TH1D *DYPT100_sumW = ((TH1D *)DYpT100->Get("h_SumWeight"));
    TH1D *DYPT250_nT = ((TH1D *)DYpT250->Get("PUdz"));
    TH1D *DYPT250_sumW = ((TH1D *)DYpT250->Get("h_SumWeight"));
    TH1D *DYPT400_nT = ((TH1D *)DYpT400->Get("PUdz"));
    TH1D *DYPT400_sumW = ((TH1D *)DYpT400->Get("h_SumWeight"));
    TH1D *DYPT650_nT = ((TH1D *)DYpT650->Get("PUdz"));
...
*/
    ...
    //PUdz->GetXaxis()->SetRangeUser(0, 50)
...
*/
    ...
    //Mx2_1_nT->GetXaxis()->SetRangeUser(0, 8);
    Mx2_1_nT->Draw("hist");
    Mx2_50_nT->Draw("hist&&same");
    Mx2_150_nT->Draw("hist&&same");
    //HT70_nT->Draw("hist&&same");
    DYPT50_nT->Draw("hist&&same");

    TLegend *l2 = new TLegend(0.60, 0.55, 0.90, 0.90);
    l2->AddEntry(Mx2_1_nT, "ctau=1mm m_{x^{2}}=1", "f");
    l2->AddEntry(Mx2_150_nT, "ctau=1mm m_{x^{2}}=150", "f");
    l2->AddEntry(Mx2_50_nT, "ctau=10mm m_{x^{2}}=50", "f");

    //l2->AddEntry(HT70_nT, "DYJets_HTBin", "f");
    l2->AddEntry(DYPT50_nT, "DYJets_pTBin", "f");
