...
void BGEM_Top()
{
    ...
    // Top
    TH1F *Top_TTTo2L2Nu_a_met = new TH1F("Top_TTTo2L2Nu_a_met", "", nnbins, nbins);
    Top_TTTo2L2Nu_a_met->Sumw2();

    TH1F *Top_TTWJetsToLNu_a_met = new TH1F("Top_TTWJetsToLNu_a_met", "", nnbins, nbins);
    Top_TTWJetsToLNu_a_met->Sumw2();

    TH1F *Top_TTWJetsToQQ_a_met = new TH1F("Top_TTWJetsToQQ_a_met", "", nnbins, nbins);
    Top_TTWJetsToQQ_a_met->Sumw2();

    TH1F *Top_TTZToLLNuNu_a_met = new TH1F("Top_TTZToLLNuNu_a_met", "", nnbins, nbins);
    Top_TTZToLLNuNu_a_met->Sumw2();

    TH1F *Top_TTZToQQ_a_met = new TH1F("Top_TTZToQQ_a_met", "", nnbins, nbins);
    Top_TTZToQQ_a_met->Sumw2();

    TH1F *Top_tW_antitop_a_met = new TH1F("Top_tW_antitop_a_met", "", nnbins, nbins);
    Top_tW_antitop_a_met->Sumw2();

    TH1F *Top_tW_top_a_met = new TH1F("Top_tW_top_a_met", "", nnbins, nbins);
    Top_tW_top_a_met->Sumw2();

    // TH1F *Top_quark_met = new TH1F("Top_quark_met", "", nnbins, nbins);
    // Top_quark_met->Sumw2();

    TH1F *Top_TTTo2L2Nu_b_met = new TH1F("Top_TTTo2L2Nu_b_met", "", nnbins, nbins);
    Top_TTTo2L2Nu_b_met->Sumw2();

    TH1F *Top_TTWJetsToLNu_b_met = new TH1F("Top_TTWJetsToLNu_b_met", "", nnbins, nbins);
    Top_TTWJetsToLNu_b_met->Sumw2();

    TH1F *Top_TTWJetsToQQ_b_met = new TH1F("Top_TTWJetsToQQ_b_met", "", nnbins, nbins);
    Top_TTWJetsToQQ_b_met->Sumw2();

    TH1F *Top_TTZToLLNuNu_b_met = new TH1F("Top_TTZToLLNuNu_b_met", "", nnbins, nbins);
    Top_TTZToLLNuNu_b_met->Sumw2();

    TH1F *Top_TTZToQQ_b_met = new TH1F("Top_TTZToQQ_b_met", "", nnbins, nbins);
    Top_TTZToQQ_b_met->Sumw2();

    TH1F *Top_tW_antitop_b_met = new TH1F("Top_tW_antitop_b_met", "", nnbins, nbins);
    Top_tW_antitop_b_met->Sumw2();

    TH1F *Top_tW_top_b_met = new TH1F("Top_tW_top_b_met", "", nnbins, nbins);
    ...
    Top_tW_top_a_met->Add(Top_tW_antitop_a_met);
    Top_tW_top_a_met->Add(Top_TTTo2L2Nu_a_met);
    Top_tW_top_a_met->Add(Top_TTWJetsToLNu_a_met);
    Top_tW_top_a_met->Add(Top_TTWJetsToQQ_a_met);
    Top_tW_top_a_met->Add(Top_TTZToLLNuNu_a_met);
    Top_tW_top_a_met->Add(Top_TTZToQQ_a_met);

    Top_tW_top_b_met->Add(Top_tW_antitop_b_met);
    Top_tW_top_b_met->Add(Top_TTTo2L2Nu_b_met);
    Top_tW_top_b_met->Add(Top_TTWJetsToLNu_b_met);
    Top_tW_top_b_met->Add(Top_TTWJetsToQQ_b_met);
    Top_tW_top_b_met->Add(Top_TTZToLLNuNu_b_met);
    Top_tW_top_b_met->Add(Top_TTZToQQ_b_met);

    Top_tW_top_a_met->Divide(Top_tW_top_b_met);

    gStyle->SetOptStat(0);
    Top_tW_top_a_met->SetTitle("Ratio of Met");
    Top_tW_top_a_met->SetLineWidth(2);
    Top_tW_top_a_met->Draw();
}