...
void quick_3D_draw()
{
    ...
    TH1D *h_MX50_Chi3DPaperlog = new TH1D("h_MX50_Chi3DPaperlog", "", 100, -10, 10);
    h_MX50_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_MX50_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_MX50_Chi3DPaperlog->Sumw2();
    TH1D *h_MX150_Chi3DPaperlog = new TH1D("h_MX150_Chi3DPaperlog", "", 100, -10, 10);
    h_MX150_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_MX150_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_MX150_Chi3DPaperlog->Sumw2();

    TH1D *h_ht0_Chi3DPaperlog = new TH1D("h_ht0_Chi3DPaperlog", "", 100, -10, 10);
    h_ht0_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_ht0_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_ht0_Chi3DPaperlog->Sumw2();

    TH1D *h_ht70_Chi3DPaperlog = new TH1D("h_ht70_Chi3DPaperlog", "", 100, -10, 10);
    h_ht70_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_ht70_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_ht70_Chi3DPaperlog->Sumw2();

    TH1D *h_ht100_Chi3DPaperlog = new TH1D("h_ht100_Chi3DPaperlog", "", 100, -10, 10);
    h_ht100_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_ht100_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_ht100_Chi3DPaperlog->Sumw2();

    TH1D *h_ht200_Chi3DPaperlog = new TH1D("h_ht200_Chi3DPaperlog", "", 100, -10, 10);
    h_ht200_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_ht200_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_ht200_Chi3DPaperlog->Sumw2();

    TH1D *h_ht400_Chi3DPaperlog = new TH1D("h_ht400_Chi3DPaperlog", "", 100, -10, 10);
    h_ht400_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_ht400_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_ht400_Chi3DPaperlog->Sumw2();

    TH1D *h_ht600_Chi3DPaperlog = new TH1D("h_ht600_Chi3DPaperlog", "", 100, -10, 10);
    h_ht600_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_ht600_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_ht600_Chi3DPaperlog->Sumw2();

    TH1D *h_ht800_Chi3DPaperlog = new TH1D("h_ht800_Chi3DPaperlog", "", 100, -10, 10);
    h_ht800_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_ht800_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_ht800_Chi3DPaperlog->Sumw2();

    TH1D *h_ht1200_Chi3DPaperlog = new TH1D("h_ht1200_Chi3DPaperlog", "", 100, -10, 10);
    h_ht1200_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_ht1200_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_ht1200_Chi3DPaperlog->Sumw2();

    TH1D *h_ht2500_Chi3DPaperlog = new TH1D("h_ht2500_Chi3DPaperlog", "", 100, -10, 10);
    h_ht2500_Chi3DPaperlog->GetXaxis()->SetTitle("");
    h_ht2500_Chi3DPaperlog->GetYaxis()->SetTitle("");
    h_ht2500_Chi3DPaperlog->Sumw2();
    ...
    TH1F *Mx2_1_3DSig = ((TH1F *)Mx2_1->Get("Track_Variable/Chi3Dlog"));
    TH1F *Mx2_50_3DSig = ((TH1F *)Mx2_50->Get("Track_Variable/Chi3Dlog"));
    TH1F *Mx2_150_3DSig = ((TH1F *)Mx2_150->Get("Track_Variable/Chi3Dlog"));
    ...
    vector<float> *v_Mx1_Chi3Dlog = new vector<float>();
    vector<float> *v_Mx50_Chi3Dlog = new vector<float>();
    vector<float> *v_Mx150_Chi3Dlog = new vector<float>();
    ...
    for (int evt = 0; evt < T_event->GetEntries(); evt++)
    {
        ...
        if (HT < 70)
        {
            for (int i = 0; i < v_ht0_Chi3Dlog->size(); i++)
            {
                h_ht0_Chi3DPaperlog->Fill((*v_ht0_Chi3Dlog)[i], I_ht0_weight * HT0Weight);
            }
        }
        else if (HT >= 70 && HT < 100)
        {
            for (int i = 0; i < v_ht0_Chi3Dlog->size(); i++)
            {
                h_ht70_Chi3DPaperlog->Fill((*v_ht0_Chi3Dlog)[i], I_ht0_weight * HT70Weight);
            }
        }
        else if (HT >= 100 && HT < 200)
        {
            for (int i = 0; i < v_ht0_Chi3Dlog->size(); i++)
            {
                h_ht100_Chi3DPaperlog->Fill((*v_ht0_Chi3Dlog)[i], I_ht0_weight * HT100Weight);
            }
        }
        else if (HT >= 200 && HT < 400)
        {
            for (int i = 0; i < v_ht0_Chi3Dlog->size(); i++)
            {
                h_ht200_Chi3DPaperlog->Fill((*v_ht0_Chi3Dlog)[i], I_ht0_weight * HT200Weight);
            }
        }
        else if (HT >= 400 && HT < 600)
        {
            for (int i = 0; i < v_ht0_Chi3Dlog->size(); i++)
            {
                h_ht400_Chi3DPaperlog->Fill((*v_ht0_Chi3Dlog)[i], I_ht0_weight * HT400Weight);
            }
        }
        else if (HT >= 600 && HT < 800)
        {
            for (int i = 0; i < v_ht0_Chi3Dlog->size(); i++)
            {
                h_ht600_Chi3DPaperlog->Fill((*v_ht0_Chi3Dlog)[i], I_ht0_weight * HT600Weight);
            }
        }
        else if (HT >= 800 && HT < 1200)
        {
            for (int i = 0; i < v_ht0_Chi3Dlog->size(); i++)
            {
                h_ht800_Chi3DPaperlog->Fill((*v_ht0_Chi3Dlog)[i], I_ht0_weight * HT800Weight);
            }
        }
        else if (HT >= 1200 && HT < 2500)
        {
            for (int i = 0; i < v_ht0_Chi3Dlog->size(); i++)
            {
                h_ht1200_Chi3DPaperlog->Fill((*v_ht0_Chi3Dlog)[i], I_ht0_weight * HT1200Weight);
            }
        }
        else if (HT >= 2500)
        {
            for (int i = 0; i < v_ht0_Chi3Dlog->size(); i++)
            {
                h_ht2500_Chi3DPaperlog->Fill((*v_ht0_Chi3Dlog)[i], I_ht0_weight * HT2500Weight);
            }
        }
    }
    TTree *T_event1;
    ...
    for (int evt = 0; evt < T_event1->GetEntries(); evt++)
    {
        ...
        if (I_ht100_nThinJets < 2)
            continue;
        for (int i = 0; i < v_ht100_Chi3Dlog->size(); i++)
        {
            h_ht100_Chi3DPaperlog->Fill((*v_ht100_Chi3Dlog)[i], I_ht100_weight * HT100Weight);
        }
    }
    TTree *T_event2;
    ...
    for (int evt = 0; evt < T_event2->GetEntries(); evt++)
    {
        ...
        if (I_ht200_nThinJets < 2)
            continue;
        for (int i = 0; i < v_ht200_Chi3Dlog->size(); i++)
        {
            h_ht200_Chi3DPaperlog->Fill((*v_ht200_Chi3Dlog)[i], I_ht200_weight * HT200Weight);
        }
    }
    TTree *T_event3;
    ...
    for (int evt = 0; evt < T_event3->GetEntries(); evt++)
    {
        ...
        if (I_ht400_nThinJets < 2)
            continue;
        for (int i = 0; i < v_ht400_Chi3Dlog->size(); i++)
        {
            h_ht400_Chi3DPaperlog->Fill((*v_ht400_Chi3Dlog)[i], I_ht400_weight * HT400Weight);
        }
    }
    TTree *T_event4;
    ...
    for (int evt = 0; evt < T_event4->GetEntries(); evt++)
    {
        ...
        if (I_ht600_nThinJets < 2)
            continue;
        for (int i = 0; i < v_ht600_Chi3Dlog->size(); i++)
        {
            h_ht600_Chi3DPaperlog->Fill((*v_ht600_Chi3Dlog)[i], I_ht600_weight * HT600Weight);
        }
    }
    TTree *T_event5;
    ...
    for (int evt = 0; evt < T_event5->GetEntries(); evt++)
    {
        ...
        if (I_ht800_nThinJets < 2)
            continue;
        for (int i = 0; i < v_ht800_Chi3Dlog->size(); i++)
        {
            h_ht800_Chi3DPaperlog->Fill((*v_ht800_Chi3Dlog)[i], I_ht800_weight * HT800Weight);
        }
    }
    TTree *T_event6;
    ...
    for (int evt = 0; evt < T_event6->GetEntries(); evt++)
    {
        ...
        if (I_ht1200_nThinJets < 2)
            continue;
        for (int i = 0; i < v_ht1200_Chi3Dlog->size(); i++)
        {
            h_ht1200_Chi3DPaperlog->Fill((*v_ht1200_Chi3Dlog)[i], I_ht1200_weight * HT1200Weight);
        }
    }
    ...
    for (int evt = 0; evt < T_event7->GetEntries(); evt++)
    {
        ...
        if (I_ht2500_nThinJets < 2)
            continue;
        for (int i = 0; i < v_ht2500_Chi3Dlog->size(); i++)
        {
            h_ht2500_Chi3DPaperlog->Fill((*v_ht2500_Chi3Dlog)[i], I_ht2500_weight * HT2500Weight);
        }
    }
    TTree *Mx1_tree;
    ...
    Mx1_tree->SetBranchAddress("v_Chi3Dlog", &v_Mx1_Chi3Dlog);
    for (int evt = 0; evt < Mx1_tree->GetEntries(); evt++)
    {
        Mx1_tree->GetEntry(evt);
        if (I_Mx1_nThinJets < 2)
            continue;
        for (int i = 0; i < v_Mx1_Chi3Dlog->size(); i++)
        {
            h_MX1_Chi3DPaperlog->Fill((*v_Mx1_Chi3Dlog)[i], I_Mx1_weight);
        }
    }
    TTree *Mx50_tree;
    ...
    Mx50_tree->SetBranchAddress("v_Chi3Dlog", &v_Mx50_Chi3Dlog);
    for (int evt = 0; evt < Mx50_tree->GetEntries(); evt++)
    {
        Mx50_tree->GetEntry(evt);
        if (I_Mx50_nThinJets < 2)
            continue;
        for (int i = 0; i < v_Mx50_Chi3Dlog->size(); i++)
        {
            h_MX50_Chi3DPaperlog->Fill((*v_Mx50_Chi3Dlog)[i], I_Mx50_weight);
        }
    }
    TTree *Mx150_tree;
    ...
    Mx150_tree->SetBranchAddress("v_Chi3Dlog", &v_Mx150_Chi3Dlog);
    for (int evt = 0; evt < Mx150_tree->GetEntries(); evt++)
    {
        Mx150_tree->GetEntry(evt);
        if (I_Mx150_nThinJets < 2)
            continue;
        for (int i = 0; i < v_Mx150_Chi3Dlog->size(); i++)
        {
            h_MX150_Chi3DPaperlog->Fill((*v_Mx150_Chi3Dlog)[i], I_Mx150_weight);
        }
    }

    h_ht0_Chi3DPaperlog->Add(h_ht70_Chi3DPaperlog);
    h_ht0_Chi3DPaperlog->Add(h_ht100_Chi3DPaperlog);
    h_ht0_Chi3DPaperlog->Add(h_ht200_Chi3DPaperlog);
    h_ht0_Chi3DPaperlog->Add(h_ht400_Chi3DPaperlog);
    h_ht0_Chi3DPaperlog->Add(h_ht600_Chi3DPaperlog);
    h_ht0_Chi3DPaperlog->Add(h_ht800_Chi3DPaperlog);
    h_ht0_Chi3DPaperlog->Add(h_ht1200_Chi3DPaperlog);
    h_ht0_Chi3DPaperlog->Add(h_ht2500_Chi3DPaperlog);

    h_MX1_Chi3DPaperlog->SetStats(0);
    h_MX1_Chi3DPaperlog->SetLineWidth(2);
    h_MX1_Chi3DPaperlog->SetLineColor(kRed);
    h_MX50_Chi3DPaperlog->SetLineWidth(2);
    h_MX50_Chi3DPaperlog->SetLineColor(kBlue);
    h_MX150_Chi3DPaperlog->SetLineWidth(2);
    h_MX150_Chi3DPaperlog->SetLineColor(kBlack);

    h_ht0_Chi3DPaperlog->SetLineWidth(2);
    h_ht0_Chi3DPaperlog->SetLineColor(MIZUASAGI);
    h_ht0_Chi3DPaperlog->SetFillColor(HIWAMOEGI);
    h_ht0_Chi3DPaperlog->SetFillStyle(3001);

    h_ht0_Chi3DPaperlog->GetYaxis()->SetTitle("N tracks /Normalized");
    h_ht0_Chi3DPaperlog->GetXaxis()->SetTitle("log_{10}(IP^{3D}_{sig})");

    auto c2 = new TCanvas("c", "BPRE");

    h_ht0_Chi3DPaperlog->DrawNormalized("hist");
    h_MX50_Chi3DPaperlog->DrawNormalized("hist&&same");
    h_MX1_Chi3DPaperlog->DrawNormalized("hist&&same");
    h_MX150_Chi3DPaperlog->DrawNormalized("hist&&same");

    TLegend *l1 = new TLegend(0.60, 0.55, 0.90, 0.90);
    l1->SetBorderSize(0);
    l1->SetTextSize(0.03);
    l1->AddEntry(h_MX1_Chi3DPaperlog, "ctau=1mm m_{x^{2}}=1", "f");
    l1->AddEntry(h_MX50_Chi3DPaperlog, "ctau=10mm m_{x^{2}}=50", "f");
    l1->AddEntry(h_MX150_Chi3DPaperlog, "ctau=1mm m_{x^{2}}=150", "f");
    l1->AddEntry(h_ht0_Chi3DPaperlog, "Drell-Yan", "f");
    l1->Draw();

    TLatex CMS;
    CMS.DrawLatex(-8., 0.16, "CMS");
    TLatex Sim;
    Sim.SetTextFont(12);
    Sim.DrawLatex(-8., 0.15, "Simulation");

    TLatex Energy;
    Energy.SetTextFont(12);
    Energy.SetTextSize(0.03);
    Energy.DrawLatex(6, 0.185, "(13TeV)");
}